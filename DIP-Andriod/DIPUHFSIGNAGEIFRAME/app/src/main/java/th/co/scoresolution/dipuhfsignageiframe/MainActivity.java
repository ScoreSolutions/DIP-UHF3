package th.co.scoresolution.dipuhfsignageiframe;
...
//import com.vrm.net.Connection;
//import com.vrm.net.Connection.OnConnectionCallBackListener;
//import th.co.scoresolution.Connection;
...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  try
       // {
       //     ad.setTitle("OUTPUT OF ADD of "+ 10 +" and "+ 12);

          //  String resp= cs.Call(10, 12);
//        }catch(Exception ex)
      //  {
        //    ad.setTitle("Error!");
