...
Partial Class GenerateCode
    ...
    Private Sub InitializeComponent()
        ...
        Me.txtDataSource.Text = "192.168.1.111"
        '
        'txtProjectCode
        '
        ...
        Me.txtProjectCode.Text = "DIP-UHF3"
        '
        'Label7
        '
        ...
        Me.txtOutputPath.Text = "D:\MyProject\DIP-UHF3\ShareObject\trunk\"
        '
        'btnGenAll
        '
