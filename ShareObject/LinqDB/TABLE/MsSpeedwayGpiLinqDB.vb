...
Namespace TABLE
    'Represents a transaction for MS_SPEEDWAY_GPI table LinqDB.
    '[Create by  on March, 13 2015]
    Public Class MsSpeedwayGpiLinqDB
        Public sub MsSpeedwayGpiLinqDB()

        End Sub 
        ' MS_SPEEDWAY_GPI
        Const _tableName As String = "MS_SPEEDWAY_GPI"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into MS_SPEEDWAY_GPI table successfully.
        ...
        '/// Returns an indication whether the current data is updated to MS_SPEEDWAY_GPI table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from MS_SPEEDWAY_GPI table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of MS_SPEEDWAY_GPI by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of MS_SPEEDWAY_GPI by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As MsSpeedwayGpiLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of MS_SPEEDWAY_GPI by specified MS_SPEEDWAY_ID_PORT_NUMBER key is retrieved successfully.
        '/// <param name=cMS_SPEEDWAY_ID_PORT_NUMBER>The MS_SPEEDWAY_ID_PORT_NUMBER key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByMS_SPEEDWAY_ID_PORT_NUMBER(cMS_SPEEDWAY_ID As Long, cPORT_NUMBER As Integer, trans As SQLTransaction) As Boolean
            Return doChkData("MS_SPEEDWAY_ID = " & DB.SetDouble(cMS_SPEEDWAY_ID) & " AND PORT_NUMBER = " & DB.SetDouble(cPORT_NUMBER), trans)
        End Function

        '/// Returns an duplicate data record of MS_SPEEDWAY_GPI by specified MS_SPEEDWAY_ID_PORT_NUMBER key is retrieved successfully.
        '/// <param name=cMS_SPEEDWAY_ID_PORT_NUMBER>The MS_SPEEDWAY_ID_PORT_NUMBER key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByMS_SPEEDWAY_ID_PORT_NUMBER(cMS_SPEEDWAY_ID As Long, cPORT_NUMBER As Integer, cid As Long, trans As SQLTransaction) As Boolean
            Return doChkData("MS_SPEEDWAY_ID = " & DB.SetDouble(cMS_SPEEDWAY_ID) & " AND PORT_NUMBER = " & DB.SetDouble(cPORT_NUMBER) & " And id <> " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of MS_SPEEDWAY_GPI by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As MsSpeedwayGpiLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table MS_SPEEDWAY_GPI
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (CREATED_BY, CREATED_DATE, UPDATED_BY, UPDATED_DATE, MS_SPEEDWAY_ID, PORT_NUMBER, IS_ENABLED, DEBOUNCE_IN_MS, AUTO_START_MODE, AUTO_START_GPI_LEVEL, AUTO_START_FIRST_DELAY, AUTO_START_PERIOD, AUTO_STOP_MODE, AUTO_STOP_GPI_LEVEL, AUTO_STOP_DURATION, BRAND_NAME, MODEL_NAME)"
                Sql += " OUTPUT INSERTED.ID, INSERTED.CREATED_BY, INSERTED.CREATED_DATE, INSERTED.UPDATED_BY, INSERTED.UPDATED_DATE, INSERTED.MS_SPEEDWAY_ID, INSERTED.PORT_NUMBER, INSERTED.IS_ENABLED, INSERTED.DEBOUNCE_IN_MS, INSERTED.AUTO_START_MODE, INSERTED.AUTO_START_GPI_LEVEL, INSERTED.AUTO_START_FIRST_DELAY, INSERTED.AUTO_START_PERIOD, INSERTED.AUTO_STOP_MODE, INSERTED.AUTO_STOP_GPI_LEVEL, INSERTED.AUTO_STOP_DURATION, INSERTED.BRAND_NAME, INSERTED.MODEL_NAME
                Sql += " VALUES("
                sql += "@_CREATED_BY" & ", "
                sql += "@_CREATED_DATE" & ", "
                sql += "@_UPDATED_BY" & ", "
        ...
        'Get update statement form table MS_SPEEDWAY_GPI
        ...
        'Get Delete Record in table MS_SPEEDWAY_GPI
        ...
        'Get Select Statement for table MS_SPEEDWAY_GPI
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATED_BY, CREATED_DATE, UPDATED_BY, UPDATED_DATE, MS_SPEEDWAY_ID, PORT_NUMBER, IS_ENABLED, DEBOUNCE_IN_MS, AUTO_START_MODE, AUTO_START_GPI_LEVEL, AUTO_START_FIRST_DELAY, AUTO_START_PERIOD, AUTO_STOP_MODE, AUTO_STOP_GPI_LEVEL, AUTO_STOP_DURATION, BRAND_NAME, MODEL_NAME FROM " & tableName
                Return Sql
            End Get
        End Property
