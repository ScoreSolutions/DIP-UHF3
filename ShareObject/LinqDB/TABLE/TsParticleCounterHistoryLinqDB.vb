...
Namespace TABLE
    'Represents a transaction for TS_PARTICLE_COUNTER_HISTORY table LinqDB.
    '[Create by  on April, 23 2015]
    Public Class TsParticleCounterHistoryLinqDB
        Public sub TsParticleCounterHistoryLinqDB()

        End Sub 
        ' TS_PARTICLE_COUNTER_HISTORY
        Const _tableName As String = "TS_PARTICLE_COUNTER_HISTORY"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TS_PARTICLE_COUNTER_HISTORY table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TS_PARTICLE_COUNTER_HISTORY table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TS_PARTICLE_COUNTER_HISTORY table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TS_PARTICLE_COUNTER_HISTORY by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TS_PARTICLE_COUNTER_HISTORY by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TsParticleCounterHistoryLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of TS_PARTICLE_COUNTER_HISTORY by specified MS_PARTICLE_COUNTER_DEVICE_ID key is retrieved successfully.
        '/// <param name=cMS_PARTICLE_COUNTER_DEVICE_ID>The MS_PARTICLE_COUNTER_DEVICE_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByMS_PARTICLE_COUNTER_DEVICE_ID(cMS_PARTICLE_COUNTER_DEVICE_ID As Long, trans As SQLTransaction) As Boolean
            Return doChkData("MS_PARTICLE_COUNTER_DEVICE_ID = " & DB.SetDouble(cMS_PARTICLE_COUNTER_DEVICE_ID) & " ", trans)
        End Function

        '/// Returns an duplicate data record of TS_PARTICLE_COUNTER_HISTORY by specified MS_PARTICLE_COUNTER_DEVICE_ID key is retrieved successfully.
        '/// <param name=cMS_PARTICLE_COUNTER_DEVICE_ID>The MS_PARTICLE_COUNTER_DEVICE_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByMS_PARTICLE_COUNTER_DEVICE_ID(cMS_PARTICLE_COUNTER_DEVICE_ID As Long, cid As Long, trans As SQLTransaction) As Boolean
            Return doChkData("MS_PARTICLE_COUNTER_DEVICE_ID = " & DB.SetDouble(cMS_PARTICLE_COUNTER_DEVICE_ID) & " " & " And id <> " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TS_PARTICLE_COUNTER_HISTORY by specified IMPORT_TIME key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of TS_PARTICLE_COUNTER_HISTORY by specified IMPORT_TIME key is retrieved successfully.
        '/// <param name=cIMPORT_TIME>The IMPORT_TIME key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of TS_PARTICLE_COUNTER_HISTORY by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TsParticleCounterHistoryLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table TS_PARTICLE_COUNTER_HISTORY
        ...
        'Get update statement form table TS_PARTICLE_COUNTER_HISTORY
        ...
        'Get Delete Record in table TS_PARTICLE_COUNTER_HISTORY
        ...
        'Get Select Statement for table TS_PARTICLE_COUNTER_HISTORY
