...
Namespace TABLE
    'Represents a transaction for TB_FILESTORE table LinqDB.
    '[Create by  on January, 15 2015]
    Public Class TbFilestoreLinqDB
        Public sub TbFilestoreLinqDB()

        End Sub 
        ' TB_FILESTORE
        Const _tableName As String = "TB_FILESTORE"
        ...
        Public Property APP_NO() As  String 
            ...
            End Set
        End Property 
        <Column(Storage:="_FILELOCATION", DbType:="BigInt")>  _
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_FILESTORE table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_FILESTORE table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_FILESTORE table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_FILESTORE by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_FILESTORE by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbFilestoreLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of TB_FILESTORE by specified condition is retrieved successfully.
        ...
        Private Function SetParameterData() As SqlParameter()
            ...
            cmbParam(2) = New SqlParameter("@_FILELOCATION", SqlDbType.BigInt)
            If _FILELOCATION IsNot Nothing Then 
                cmbParam(2).Value = _FILELOCATION.Value
            Else
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("filelocation")) = False Then _filelocation = Convert.ToInt64(Rdr("filelocation"))
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbFilestoreLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table TB_FILESTORE
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, APP_NO, FILELOCATION, CREATEBY, CREATEON, UPDATEBY, UPDATEON)"
                Sql += " OUTPUT INSERTED.ID, INSERTED.APP_NO, INSERTED.FILELOCATION, INSERTED.CREATEBY, INSERTED.CREATEON, INSERTED.UPDATEBY, INSERTED.UPDATEON
                Sql += " VALUES("
                sql += "@_ID" & ", "
                sql += "@_APP_NO" & ", "
                sql += "@_FILELOCATION" & ", "
        ...
        'Get update statement form table TB_FILESTORE
        ...
        'Get Delete Record in table TB_FILESTORE
        ...
        'Get Select Statement for table TB_FILESTORE
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, APP_NO, FILELOCATION, CREATEBY, CREATEON, UPDATEBY, UPDATEON FROM " & tableName
                Return Sql
            End Get
        End Property
