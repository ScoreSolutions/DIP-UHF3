...
Namespace TABLE
    ...
    Public Class TbAlarmLogLinqDB
        ...
        'Generate Field List
        Dim _ID As Long = 0
        Dim _ALARM_DATETIME As  System.Nullable(Of DateTime)  = New DateTime(1,1,1)
        Dim _REQUISITION_ID As  System.Nullable(Of Long)  = 0
        ...
        Public Property ID() As Long
            ...
            End Set
        End Property 
        <Column(Storage:="_ALARM_DATETIME", DbType:="DateTime")>  _
        Public Property ALARM_DATETIME() As  System.Nullable(Of DateTime) 
            Get
            ...
            End Set
        End Property 
        <Column(Storage:="_REQUISITION_ID", DbType:="BigInt")>  _
        Public Property REQUISITION_ID() As  System.Nullable(Of Long) 
            Get
       ...
       'Define Public Method 
        ...
        Private Function SetParameterData() As SqlParameter()
            ...
            cmbParam(1) = New SqlParameter("@_ALARM_DATETIME", SqlDbType.DateTime)
            If _ALARM_DATETIME.Value.Year > 1 Then 
                cmbParam(1).Value = _ALARM_DATETIME.Value
            Else
                cmbParam(1).Value = DBNull.value
            End If

            cmbParam(2) = New SqlParameter("@_REQUISITION_ID", SqlDbType.BigInt)
            If _REQUISITION_ID IsNot Nothing Then 
                cmbParam(2).Value = _REQUISITION_ID.Value
            Else
        ...
        Private ReadOnly Property SqlInsert() As String 
            Get
                ...
                Sql += " OUTPUT INSERTED.ID, INSERTED.ALARM_DATETIME, INSERTED.REQUISITION_ID, INSERTED.CREATEBY, INSERTED.CREATEON, INSERTED.UPDATEBY, INSERTED.UPDATEON
                Sql += " VALUES("
                sql += "@_ID" & ", "
                sql += "@_ALARM_DATETIME" & ", "
                sql += "@_REQUISITION_ID" & ", "
        ...
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "ALARM_DATETIME = " & "@_ALARM_DATETIME" & ", "
        ...
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, ALARM_DATETIME, REQUISITION_ID, CREATEBY, CREATEON, UPDATEBY, UPDATEON FROM " & tableName
                Return Sql
            End Get
        End Property
