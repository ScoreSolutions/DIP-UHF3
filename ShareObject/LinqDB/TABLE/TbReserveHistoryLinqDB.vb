...
Namespace TABLE
    'Represents a transaction for TB_RESERVE_HISTORY table LinqDB.
    '[Create by  on January, 15 2015]
    Public Class TbReserveHistoryLinqDB
        Public sub TbReserveHistoryLinqDB()

        End Sub 
        ' TB_RESERVE_HISTORY
        Const _tableName As String = "TB_RESERVE_HISTORY"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_RESERVE_HISTORY table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_RESERVE_HISTORY table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_RESERVE_HISTORY table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_RESERVE_HISTORY by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_RESERVE_HISTORY by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbReserveHistoryLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of TB_RESERVE_HISTORY by specified condition is retrieved successfully.
        ...
        Private Function SetParameterData() As SqlParameter()
            ...
            cmbParam(15) = New SqlParameter("@_RESERVE_ID", SqlDbType.BigInt)
            If _RESERVE_ID IsNot Nothing Then 
                cmbParam(15).Value = _RESERVE_ID.Value
            Else
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbReserveHistoryLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table TB_RESERVE_HISTORY
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (REQUIDITION_ID, MEMBER_ID, MEMBER_NAME, RESERVE_DATE, RESERVE_ORDER, RESERVE_JOB_ID, REF_INNOVA_ID, RESERVE_STATUS, BORROWSTATUS, OFFICER_ID_RECEIVE, CREATEBY, CREATEON, UPDATEBY, UPDATEON, RESERVE_ID)"
                Sql += " OUTPUT INSERTED.ID, INSERTED.REQUIDITION_ID, INSERTED.MEMBER_ID, INSERTED.MEMBER_NAME, INSERTED.RESERVE_DATE, INSERTED.RESERVE_ORDER, INSERTED.RESERVE_JOB_ID, INSERTED.REF_INNOVA_ID, INSERTED.RESERVE_STATUS, INSERTED.BORROWSTATUS, INSERTED.OFFICER_ID_RECEIVE, INSERTED.CREATEBY, INSERTED.CREATEON, INSERTED.UPDATEBY, INSERTED.UPDATEON, INSERTED.RESERVE_ID
                Sql += " VALUES("
                sql += "@_REQUIDITION_ID" & ", "
                sql += "@_MEMBER_ID" & ", "
                sql += "@_MEMBER_NAME" & ", "
        ...
        'Get update statement form table TB_RESERVE_HISTORY
        ...
        'Get Delete Record in table TB_RESERVE_HISTORY
        ...
        'Get Select Statement for table TB_RESERVE_HISTORY
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, REQUIDITION_ID, MEMBER_ID, MEMBER_NAME, RESERVE_DATE, RESERVE_ORDER, RESERVE_JOB_ID, REF_INNOVA_ID, RESERVE_STATUS, BORROWSTATUS, OFFICER_ID_RECEIVE, CREATEBY, CREATEON, UPDATEBY, UPDATEON, RESERVE_ID FROM " & tableName
                Return Sql
            End Get
        End Property
