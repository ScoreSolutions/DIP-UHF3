...
Namespace TABLE
    'Represents a transaction for MS_SPEEDWAY_SETTING table LinqDB.
    '[Create by  on January, 21 2015]
    Public Class MsSpeedwaySettingLinqDB
        Public sub MsSpeedwaySettingLinqDB()

        End Sub 
        ' MS_SPEEDWAY_SETTING
        Const _tableName As String = "MS_SPEEDWAY_SETTING"
        ...
        Private Sub ClearData()
            ...
            _SETTING_TIME_CORRECT_ENABLED = ""
            _FILTERS_MODE = ""
            _KEEPALIVE_IS_ENABLED = ""
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into MS_SPEEDWAY_SETTING table successfully.
        ...
        '/// Returns an indication whether the current data is updated to MS_SPEEDWAY_SETTING table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from MS_SPEEDWAY_SETTING table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of MS_SPEEDWAY_SETTING by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of MS_SPEEDWAY_SETTING by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As MsSpeedwaySettingLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of MS_SPEEDWAY_SETTING by specified MS_SPEEDWAY_ID key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of MS_SPEEDWAY_SETTING by specified MS_SPEEDWAY_ID key is retrieved successfully.
        '/// <param name=cMS_SPEEDWAY_ID>The MS_SPEEDWAY_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of MS_SPEEDWAY_SETTING by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As MsSpeedwaySettingLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get update statement form table MS_SPEEDWAY_SETTING
        ...
        'Get Delete Record in table MS_SPEEDWAY_SETTING
        ...
        'Get Select Statement for table MS_SPEEDWAY_SETTING
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATED_BY, CREATED_DATE, UPDATED_BY, UPDATED_DATE, MS_SPEEDWAY_ID, SETTING_LABEL, SETTING_DESCRIPTION, SETTING_SEARCH_MODE, SETTING_SESSION, SETTING_TAG_POPULATE_ESTIMATE, SETTING_TIME_CORRECT_ENABLED, FILTERS_MODE, KEEPALIVE_IS_ENABLED, KEEPALIVE_PERIOD_IN_MS, KEEPALIVE_LINK_DOWN_THRESHOLD FROM " & tableName
                Return Sql
            End Get
        End Property
