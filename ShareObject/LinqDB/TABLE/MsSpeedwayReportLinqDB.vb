...
Namespace TABLE
    'Represents a transaction for MS_SPEEDWAY_REPORT table LinqDB.
    '[Create by  on January, 21 2015]
    Public Class MsSpeedwayReportLinqDB
        Public sub MsSpeedwayReportLinqDB()

        End Sub 
        ' MS_SPEEDWAY_REPORT
        Const _tableName As String = "MS_SPEEDWAY_REPORT"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into MS_SPEEDWAY_REPORT table successfully.
        ...
        '/// Returns an indication whether the current data is updated to MS_SPEEDWAY_REPORT table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from MS_SPEEDWAY_REPORT table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of MS_SPEEDWAY_REPORT by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of MS_SPEEDWAY_REPORT by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As MsSpeedwayReportLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of MS_SPEEDWAY_REPORT by specified MS_SPEEDWAY_SETTING_ID key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of MS_SPEEDWAY_REPORT by specified MS_SPEEDWAY_SETTING_ID key is retrieved successfully.
        '/// <param name=cMS_SPEEDWAY_SETTING_ID>The MS_SPEEDWAY_SETTING_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of MS_SPEEDWAY_REPORT by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As MsSpeedwayReportLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table MS_SPEEDWAY_REPORT
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (CREATED_BY, CREATED_DATE, UPDATED_BY, UPDATED_DATE, MS_SPEEDWAY_SETTING_ID, REPORT_MODE, INCLUDE_PEAK_RSSI, INCLUDE_ANTENNA_PORT_NUMBER, INCLUDE_FIRST_SEEN_TIME, INCLUDE_LAST_SEEN_TIME, INCLUDE_SEEN_COUNT, INCLUDE_CHANNEL, INCLUDE_PHASE_ANGLE, INCLUDE_SERIALIZED_TID)"
                Sql += " OUTPUT INSERTED.ID, INSERTED.CREATED_BY, INSERTED.CREATED_DATE, INSERTED.UPDATED_BY, INSERTED.UPDATED_DATE, INSERTED.MS_SPEEDWAY_SETTING_ID, INSERTED.REPORT_MODE, INSERTED.INCLUDE_PEAK_RSSI, INSERTED.INCLUDE_ANTENNA_PORT_NUMBER, INSERTED.INCLUDE_FIRST_SEEN_TIME, INSERTED.INCLUDE_LAST_SEEN_TIME, INSERTED.INCLUDE_SEEN_COUNT, INSERTED.INCLUDE_CHANNEL, INSERTED.INCLUDE_PHASE_ANGLE, INSERTED.INCLUDE_SERIALIZED_TID
                Sql += " VALUES("
                sql += "@_CREATED_BY" & ", "
                sql += "@_CREATED_DATE" & ", "
                sql += "@_UPDATED_BY" & ", "
        ...
        'Get update statement form table MS_SPEEDWAY_REPORT
        ...
        'Get Delete Record in table MS_SPEEDWAY_REPORT
        ...
        'Get Select Statement for table MS_SPEEDWAY_REPORT
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATED_BY, CREATED_DATE, UPDATED_BY, UPDATED_DATE, MS_SPEEDWAY_SETTING_ID, REPORT_MODE, INCLUDE_PEAK_RSSI, INCLUDE_ANTENNA_PORT_NUMBER, INCLUDE_FIRST_SEEN_TIME, INCLUDE_LAST_SEEN_TIME, INCLUDE_SEEN_COUNT, INCLUDE_CHANNEL, INCLUDE_PHASE_ANGLE, INCLUDE_SERIALIZED_TID FROM " & tableName
                Return Sql
            End Get
        End Property
