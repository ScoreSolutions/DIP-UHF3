...
Namespace TABLE
    'Represents a transaction for MS_HUMIDITY_TEMP_DEVICE table LinqDB.
    '[Create by  on April, 1 2015]
    Public Class MsHumidityTempDeviceLinqDB
        Public sub MsHumidityTempDeviceLinqDB()

        End Sub 
        ' MS_HUMIDITY_TEMP_DEVICE
        Const _tableName As String = "MS_HUMIDITY_TEMP_DEVICE"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into MS_HUMIDITY_TEMP_DEVICE table successfully.
        ...
        '/// Returns an indication whether the current data is updated to MS_HUMIDITY_TEMP_DEVICE table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from MS_HUMIDITY_TEMP_DEVICE table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of MS_HUMIDITY_TEMP_DEVICE by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of MS_HUMIDITY_TEMP_DEVICE by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As MsHumidityTempDeviceLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of MS_HUMIDITY_TEMP_DEVICE by specified SERIAL_NO key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of MS_HUMIDITY_TEMP_DEVICE by specified SERIAL_NO key is retrieved successfully.
        '/// <param name=cSERIAL_NO>The SERIAL_NO key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of MS_HUMIDITY_TEMP_DEVICE by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As MsHumidityTempDeviceLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table MS_HUMIDITY_TEMP_DEVICE
        ...
        'Get update statement form table MS_HUMIDITY_TEMP_DEVICE
        ...
        'Get Delete Record in table MS_HUMIDITY_TEMP_DEVICE
        ...
        'Get Select Statement for table MS_HUMIDITY_TEMP_DEVICE
