...
Namespace TABLE
    'Represents a transaction for TB_CLASSGROUP table LinqDB.
    '[Create by  on January, 14 2015]
    Public Class TbClassgroupLinqDB
        Public sub TbClassgroupLinqDB()

        End Sub 
        ' TB_CLASSGROUP
        Const _tableName As String = "TB_CLASSGROUP"
        ...
        Public Property DESCRIPTION() As  String 
            ...
            End Set
        End Property 
        <Column(Storage:="_ACTIVE", DbType:="BigInt")>  _
        Public Property ACTIVE() As  System.Nullable(Of Long) 
            ...
            End Set
        End Property 
        <Column(Storage:="_PAT_TYPE", DbType:="VarChar(1)")>  _
        Public Property PAT_TYPE() As  String 
            Get
                Return _PAT_TYPE
            End Get
            Set(ByVal value As  String )
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_CLASSGROUP table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_CLASSGROUP table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_CLASSGROUP table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_CLASSGROUP by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_CLASSGROUP by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbClassgroupLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of TB_CLASSGROUP by specified condition is retrieved successfully.
        ...
        Private Function SetParameterData() As SqlParameter()
            ...
            cmbParam(1) = New SqlParameter("@_NAME", SqlDbType.VarChar)
            cmbParam(1).Value = _NAME
            ...
            cmbParam(3) = New SqlParameter("@_ACTIVE", SqlDbType.BigInt)
            If _ACTIVE IsNot Nothing Then 
                cmbParam(3).Value = _ACTIVE.Value
            Else
                cmbParam(3).Value = DBNull.value
            End IF

            cmbParam(4) = New SqlParameter("@_PAT_TYPE", SqlDbType.VarChar)
            If _PAT_TYPE.Trim <> "" Then 
                cmbParam(4).Value = _PAT_TYPE
            Else
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("active")) = False Then _active = Convert.ToInt64(Rdr("active"))
                        If Convert.IsDBNull(Rdr("pat_type")) = False Then _pat_type = Rdr("pat_type").ToString()
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbClassgroupLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table TB_CLASSGROUP
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, NAME, DESCRIPTION, ACTIVE, PAT_TYPE, DEPARTMENT_ID, CREATEBY, CREATEON, UPDATEBY, UPDATEON)"
                Sql += " OUTPUT INSERTED.ID, INSERTED.NAME, INSERTED.DESCRIPTION, INSERTED.ACTIVE, INSERTED.PAT_TYPE, INSERTED.DEPARTMENT_ID, INSERTED.CREATEBY, INSERTED.CREATEON, INSERTED.UPDATEBY, INSERTED.UPDATEON
                Sql += " VALUES("
                sql += "@_ID" & ", "
                sql += "@_NAME" & ", "
                sql += "@_DESCRIPTION" & ", "
        ...
        'Get update statement form table TB_CLASSGROUP
        ...
        'Get Delete Record in table TB_CLASSGROUP
        ...
        'Get Select Statement for table TB_CLASSGROUP
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, NAME, DESCRIPTION, ACTIVE, PAT_TYPE, DEPARTMENT_ID, CREATEBY, CREATEON, UPDATEBY, UPDATEON FROM " & tableName
                Return Sql
            End Get
        End Property
