...
Namespace TABLE
    ...
    Public Class CfSysconfigLinqDB
        ...
        Public Property CONFIG_VALUE() As String
            ...
            End Set
        End Property 
        <Column(Storage:="_CONFIG_DESC", DbType:="VarChar(255) NOT NULL ",CanBeNull:=false)>  _
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the record of CF_SYSCONFIG by specified CONFIG_NAME key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of CF_SYSCONFIG by specified CONFIG_NAME key is retrieved successfully.
        '/// <param name=cCONFIG_NAME>The CONFIG_NAME key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As CfSysconfigLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (CREATED_BY, CREATED_DATE, UPDATED_BY, UPDATED_DATE, CONFIG_NAME, CONFIG_VALUE, CONFIG_DESC)"
                Sql += " OUTPUT INSERTED.ID, INSERTED.CREATED_BY, INSERTED.CREATED_DATE, INSERTED.UPDATED_BY, INSERTED.UPDATED_DATE, INSERTED.CONFIG_NAME, INSERTED.CONFIG_VALUE, INSERTED.CONFIG_DESC
                Sql += " VALUES("
                sql += "@_CREATED_BY" & ", "
                sql += "@_CREATED_DATE" & ", "
                sql += "@_UPDATED_BY" & ", "
        ...
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATED_BY, CREATED_DATE, UPDATED_BY, UPDATED_DATE, CONFIG_NAME, CONFIG_VALUE, CONFIG_DESC FROM " & tableName
                Return Sql
            End Get
        End Property
