...
Namespace TABLE
    'Represents a transaction for MS_PARTICLE_COUNTER_DEVICE table LinqDB.
    '[Create by  on April, 23 2015]
    Public Class MsParticleCounterDeviceLinqDB
        Public sub MsParticleCounterDeviceLinqDB()

        End Sub 
        ' MS_PARTICLE_COUNTER_DEVICE
        Const _tableName As String = "MS_PARTICLE_COUNTER_DEVICE"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into MS_PARTICLE_COUNTER_DEVICE table successfully.
        ...
        '/// Returns an indication whether the current data is updated to MS_PARTICLE_COUNTER_DEVICE table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from MS_PARTICLE_COUNTER_DEVICE table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of MS_PARTICLE_COUNTER_DEVICE by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of MS_PARTICLE_COUNTER_DEVICE by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As MsParticleCounterDeviceLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of MS_PARTICLE_COUNTER_DEVICE by specified SERIAL_NO key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of MS_PARTICLE_COUNTER_DEVICE by specified SERIAL_NO key is retrieved successfully.
        '/// <param name=cSERIAL_NO>The SERIAL_NO key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of MS_PARTICLE_COUNTER_DEVICE by specified MS_ROOM_ID key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of MS_PARTICLE_COUNTER_DEVICE by specified MS_ROOM_ID key is retrieved successfully.
        '/// <param name=cMS_ROOM_ID>The MS_ROOM_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of MS_PARTICLE_COUNTER_DEVICE by specified condition is retrieved successfully.
        ...
        Private Function SetParameterData() As SqlParameter()
            ...
            cmbParam(6) = New SqlParameter("@_BRAND_NAME", SqlDbType.VarChar)
            cmbParam(6).Value = _BRAND_NAME

            cmbParam(7) = New SqlParameter("@_MODEL_NAME", SqlDbType.VarChar)
            cmbParam(7).Value = _MODEL_NAME

            cmbParam(8) = New SqlParameter("@_MS_ROOM_ID", SqlDbType.BigInt)
            cmbParam(8).Value = _MS_ROOM_ID
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As MsParticleCounterDeviceLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table MS_PARTICLE_COUNTER_DEVICE
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (CREATED_BY, CREATED_DATE, UPDATED_BY, UPDATED_DATE, SERIAL_NO, BRAND_NAME, MODEL_NAME, MS_ROOM_ID, INSTALL_POSITION, ACTIVE_STATUS)"
                Sql += " OUTPUT INSERTED.ID, INSERTED.CREATED_BY, INSERTED.CREATED_DATE, INSERTED.UPDATED_BY, INSERTED.UPDATED_DATE, INSERTED.SERIAL_NO, INSERTED.BRAND_NAME, INSERTED.MODEL_NAME, INSERTED.MS_ROOM_ID, INSERTED.INSTALL_POSITION, INSERTED.ACTIVE_STATUS
                Sql += " VALUES("
                sql += "@_CREATED_BY" & ", "
                sql += "@_CREATED_DATE" & ", "
                sql += "@_UPDATED_BY" & ", "
        ...
        'Get update statement form table MS_PARTICLE_COUNTER_DEVICE
        ...
        'Get Delete Record in table MS_PARTICLE_COUNTER_DEVICE
        ...
        'Get Select Statement for table MS_PARTICLE_COUNTER_DEVICE
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATED_BY, CREATED_DATE, UPDATED_BY, UPDATED_DATE, SERIAL_NO, BRAND_NAME, MODEL_NAME, MS_ROOM_ID, INSTALL_POSITION, ACTIVE_STATUS FROM " & tableName
                Return Sql
            End Get
        End Property
