...
Namespace TABLE
    ...
    Public Class MsScreenLinqDB
        ...
        Dim _MS_SUBMODULE_ID As Long = 0
        ...
        Public Property MS_MODULE_ID() As Long
            ...
            End Set
        End Property 
        <Column(Storage:="_MS_SUBMODULE_ID", DbType:="BigInt NOT NULL ",CanBeNull:=false)>  _
        Public Property MS_SUBMODULE_ID() As Long
            Get
        ...
        Public Property ROWID_SUBPARENTMENU() As Long
            ...
            End Set
        End Property 
        <Column(Storage:="_SCREENID", DbType:="VarChar(50)")>  _
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the record of MS_SCREEN by specified MS_MODULE_ID_MS_SUBMODULE_ID_SCREENNAME key is retrieved successfully.
        '/// <param name=cMS_MODULE_ID_MS_SUBMODULE_ID_SCREENNAME>The MS_MODULE_ID_MS_SUBMODULE_ID_SCREENNAME key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByMS_MODULE_ID_MS_SUBMODULE_ID_SCREENNAME(cMS_MODULE_ID As Long, cMS_SUBMODULE_ID As Long, cSCREENNAME As String, trans As SQLTransaction) As Boolean
            Return doChkData("MS_MODULE_ID = " & DB.SetDouble(cMS_MODULE_ID) & " AND MS_SUBMODULE_ID = " & DB.SetDouble(cMS_SUBMODULE_ID) & " AND SCREENNAME = " & DB.SetString(cSCREENNAME), trans)
        End Function

        '/// Returns an duplicate data record of MS_SCREEN by specified MS_MODULE_ID_MS_SUBMODULE_ID_SCREENNAME key is retrieved successfully.
        '/// <param name=cMS_MODULE_ID_MS_SUBMODULE_ID_SCREENNAME>The MS_MODULE_ID_MS_SUBMODULE_ID_SCREENNAME key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByMS_MODULE_ID_MS_SUBMODULE_ID_SCREENNAME(cMS_MODULE_ID As Long, cMS_SUBMODULE_ID As Long, cSCREENNAME As String, cid As Long, trans As SQLTransaction) As Boolean
            Return doChkData("MS_MODULE_ID = " & DB.SetDouble(cMS_MODULE_ID) & " AND MS_SUBMODULE_ID = " & DB.SetDouble(cMS_SUBMODULE_ID) & " AND SCREENNAME = " & DB.SetString(cSCREENNAME) & " And id <> " & DB.SetDouble(cid) & " ", trans)
        End Function
        ...
        Private Function SetParameterData() As SqlParameter()
            ...
            cmbParam(6) = New SqlParameter("@_MS_SUBMODULE_ID", SqlDbType.BigInt)
            cmbParam(6).Value = _MS_SUBMODULE_ID

            cmbParam(7) = New SqlParameter("@_ROWID_ROOTMENU", SqlDbType.BigInt)
            cmbParam(7).Value = _ROWID_ROOTMENU

            cmbParam(8) = New SqlParameter("@_ROWID_PARENTMENU", SqlDbType.BigInt)
            cmbParam(8).Value = _ROWID_PARENTMENU

            cmbParam(9) = New SqlParameter("@_ROWID_SUBPARENTMENU", SqlDbType.BigInt)
            cmbParam(9).Value = _ROWID_SUBPARENTMENU

            cmbParam(10) = New SqlParameter("@_SCREENID", SqlDbType.VarChar)
            If _SCREENID.Trim <> "" Then 
                cmbParam(10).Value = _SCREENID
            Else
                cmbParam(10).Value = DBNull.value
            End If

            cmbParam(11) = New SqlParameter("@_SCREENNAME", SqlDbType.VarChar)
            If _SCREENNAME.Trim <> "" Then 
                cmbParam(11).Value = _SCREENNAME
            Else
                cmbParam(11).Value = DBNull.value
            End If

            cmbParam(12) = New SqlParameter("@_NAVIGATEURL", SqlDbType.VarChar)
            If _NAVIGATEURL.Trim <> "" Then 
                cmbParam(12).Value = _NAVIGATEURL
            Else
                cmbParam(12).Value = DBNull.value
            End If

            cmbParam(13) = New SqlParameter("@_REMARK", SqlDbType.VarChar)
            If _REMARK.Trim <> "" Then 
                cmbParam(13).Value = _REMARK
            Else
                cmbParam(13).Value = DBNull.value
            End If

            cmbParam(14) = New SqlParameter("@_ISMENU", SqlDbType.Char)
            cmbParam(14).Value = _ISMENU

            cmbParam(15) = New SqlParameter("@_ISNOTUSE", SqlDbType.Char)
            cmbParam(15).Value = _ISNOTUSE

            cmbParam(16) = New SqlParameter("@_NOTUSEDATE", SqlDbType.DateTime)
            If _NOTUSEDATE.Value.Year > 1 Then 
                cmbParam(16).Value = _NOTUSEDATE.Value
            Else
        ...
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATED_BY, CREATED_DATE, UPDATED_BY, UPDATED_DATE, MS_MODULE_ID, MS_SUBMODULE_ID, ROWID_ROOTMENU, ROWID_PARENTMENU, ROWID_SUBPARENTMENU, SCREENID, SCREENNAME, NAVIGATEURL, REMARK, ISMENU, ISNOTUSE, NOTUSEDATE, IMAGEURL, ACTIVE_STATUS)"
                Sql += " OUTPUT INSERTED.ID, INSERTED.CREATED_BY, INSERTED.CREATED_DATE, INSERTED.UPDATED_BY, INSERTED.UPDATED_DATE, INSERTED.MS_MODULE_ID, INSERTED.MS_SUBMODULE_ID, INSERTED.ROWID_ROOTMENU, INSERTED.ROWID_PARENTMENU, INSERTED.ROWID_SUBPARENTMENU, INSERTED.SCREENID, INSERTED.SCREENNAME, INSERTED.NAVIGATEURL, INSERTED.REMARK, INSERTED.ISMENU, INSERTED.ISNOTUSE, INSERTED.NOTUSEDATE, INSERTED.IMAGEURL, INSERTED.ACTIVE_STATUS
                Sql += " VALUES("
                sql += "@_ID" & ", "
                sql += "@_CREATED_BY" & ", "
                sql += "@_CREATED_DATE" & ", "
        ...
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATED_BY, CREATED_DATE, UPDATED_BY, UPDATED_DATE, MS_MODULE_ID, MS_SUBMODULE_ID, ROWID_ROOTMENU, ROWID_PARENTMENU, ROWID_SUBPARENTMENU, SCREENID, SCREENNAME, NAVIGATEURL, REMARK, ISMENU, ISNOTUSE, NOTUSEDATE, IMAGEURL, ACTIVE_STATUS FROM " & tableName
                Return Sql
            End Get
        End Property
