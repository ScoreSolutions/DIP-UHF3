...
Namespace TABLE
    'Represents a transaction for TB_PERMISSION table LinqDB.
    '[Create by  on Febuary, 5 2015]
    Public Class TbPermissionLinqDB
        Public Sub TbPermissionLinqDB()
        ...
        Public Property ID() As Long
            ...
            End Set
        End Property
        <Column(Storage:="_PERMISSION_NAME", DbType:="VarChar(200)")> _
        Public Property PERMISSION_NAME() As String
            ...
            End Set
        End Property
        <Column(Storage:="_PERMISSION_DESC", DbType:="VarChar(500)")> _
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbPermissionLinqDB
        ...
        Private Function SetParameterData() As SqlParameter()
            ...
            cmbParam(1) = New SqlParameter("@_PERMISSION_NAME", SqlDbType.VarChar)
            If _PERMISSION_NAME.Trim <> "" Then
                cmbParam(1).Value = _PERMISSION_NAME
            Else
                cmbParam(1).Value = DBNull.value
            End If

            cmbParam(2) = New SqlParameter("@_PERMISSION_DESC", SqlDbType.VarChar)
            If _PERMISSION_DESC.Trim <> "" Then
                cmbParam(2).Value = _PERMISSION_DESC
            Else
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbPermissionLinqDB
            ClearData()
            _haveData = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        Private ReadOnly Property SqlInsert() As String
            Get
                Dim Sql As String = ""
                Sql += "INSERT INTO " & tableName & " (ID, PERMISSION_NAME, PERMISSION_DESC, CREATEBY, CREATEON, UPDATEBY, UPDATEON, ACTIVE_STATUS)"
                Sql += " OUTPUT INSERTED.ID, INSERTED.PERMISSION_NAME, INSERTED.PERMISSION_DESC, INSERTED.CREATEBY, INSERTED.CREATEON, INSERTED.UPDATEBY, INSERTED.UPDATEON, INSERTED.ACTIVE_STATUS"
                Sql += " VALUES("
                sql += "@_ID" & ", "
                sql += "@_PERMISSION_NAME" & ", "
                sql += "@_PERMISSION_DESC" & ", "
                sql += "@_CREATEBY" & ", "
                sql += "@_CREATEON" & ", "
                sql += "@_UPDATEBY" & ", "
                sql += "@_UPDATEON" & ", "
        ...
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "PERMISSION_NAME = " & "@_PERMISSION_NAME" & ", "
                Sql += "PERMISSION_DESC = " & "@_PERMISSION_DESC" & ", "
        ...
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, PERMISSION_NAME, PERMISSION_DESC, CREATEBY, CREATEON, UPDATEBY, UPDATEON, ACTIVE_STATUS FROM " & tableName
                Return Sql
            End Get
        End Property
