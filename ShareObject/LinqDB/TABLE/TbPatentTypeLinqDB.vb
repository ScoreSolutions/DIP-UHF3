...
Namespace TABLE
    'Represents a transaction for TB_PATENT_TYPE table LinqDB.
    '[Create by  on January, 16 2015]
    Public Class TbPatentTypeLinqDB
        Public sub TbPatentTypeLinqDB()
        ...
        Public Property ID() As Long
            ...
            End Set
        End Property 
        <Column(Storage:="_PATENT_TYPE_CODE", DbType:="VarChar(50)")>  _
        Public Property PATENT_TYPE_CODE() As  String 
            ...
            End Set
        End Property 
        <Column(Storage:="_PATENT_TYPE_NAME", DbType:="VarChar(200)")>  _
       ...
       'Define Public Method 
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbPatentTypeLinqDB
        ...
        Private Function SetParameterData() As SqlParameter()
            ...
            cmbParam(1) = New SqlParameter("@_PATENT_TYPE_CODE", SqlDbType.VarChar)
            If _PATENT_TYPE_CODE.Trim <> "" Then 
                cmbParam(1).Value = _PATENT_TYPE_CODE
            Else
                cmbParam(1).Value = DBNull.value
            End If

            cmbParam(2) = New SqlParameter("@_PATENT_TYPE_NAME", SqlDbType.VarChar)
            If _PATENT_TYPE_NAME.Trim <> "" Then 
                cmbParam(2).Value = _PATENT_TYPE_NAME
            Else
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbPatentTypeLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, PATENT_TYPE_CODE, PATENT_TYPE_NAME, CREATEBY, CREATEON, UPDATEBY, UPDATEON, ACTIVE_STATUS)"
                Sql += " OUTPUT INSERTED.ID, INSERTED.PATENT_TYPE_CODE, INSERTED.PATENT_TYPE_NAME, INSERTED.CREATEBY, INSERTED.CREATEON, INSERTED.UPDATEBY, INSERTED.UPDATEON, INSERTED.ACTIVE_STATUS
                Sql += " VALUES("
                sql += "@_ID" & ", "
                sql += "@_PATENT_TYPE_CODE" & ", "
        ...
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "PATENT_TYPE_CODE = " & "@_PATENT_TYPE_CODE" & ", "
        ...
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, PATENT_TYPE_CODE, PATENT_TYPE_NAME, CREATEBY, CREATEON, UPDATEBY, UPDATEON, ACTIVE_STATUS FROM " & tableName
                Return Sql
            End Get
        End Property
