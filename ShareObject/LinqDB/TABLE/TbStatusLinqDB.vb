...
Namespace TABLE
    'Represents a transaction for TB_STATUS table LinqDB.
    '[Create by  on January, 15 2015]
    Public Class TbStatusLinqDB
        Public sub TbStatusLinqDB()
        ...
        Public Property STATUS_NAME() As  String 
            ...
            End Set
        End Property 
        <Column(Storage:="_DESCRIPTION", DbType:="VarChar(100)")>  _
       ...
       'Define Public Method 
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbStatusLinqDB
        ...
        Private Function SetParameterData() As SqlParameter()
            ...
            cmbParam(1) = New SqlParameter("@_STATUS_NAME", SqlDbType.VarChar)
            If _STATUS_NAME.Trim <> "" Then 
                cmbParam(1).Value = _STATUS_NAME
            Else
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbStatusLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, STATUS_NAME, DESCRIPTION, CREATEBY, CREATEON, UPDATEBY, UPDATEON)"
                Sql += " OUTPUT INSERTED.ID, INSERTED.STATUS_NAME, INSERTED.DESCRIPTION, INSERTED.CREATEBY, INSERTED.CREATEON, INSERTED.UPDATEBY, INSERTED.UPDATEON
                Sql += " VALUES("
                sql += "@_ID" & ", "
                sql += "@_STATUS_NAME" & ", "
                sql += "@_DESCRIPTION" & ", "
        ...
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, STATUS_NAME, DESCRIPTION, CREATEBY, CREATEON, UPDATEBY, UPDATEON FROM " & tableName
                Return Sql
            End Get
        End Property
