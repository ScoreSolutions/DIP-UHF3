...
Namespace TABLE
    'Represents a transaction for TB_POSITION table LinqDB.
    '[Create by  on January, 15 2015]
    Public Class TbPositionLinqDB
        Public sub TbPositionLinqDB()
        ...
        Public Property ID() As Long
            ...
            End Set
        End Property 
        <Column(Storage:="_POSITION_CODE", DbType:="VarChar(50)")>  _
        Public Property POSITION_CODE() As  String 
            ...
            End Set
        End Property 
        <Column(Storage:="_POSITION_NAME", DbType:="VarChar(200)")>  _
       ...
       'Define Public Method 
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbPositionLinqDB
        ...
        Private Function SetParameterData() As SqlParameter()
            ...
            cmbParam(1) = New SqlParameter("@_POSITION_CODE", SqlDbType.VarChar)
            If _POSITION_CODE.Trim <> "" Then 
                cmbParam(1).Value = _POSITION_CODE
            Else
                cmbParam(1).Value = DBNull.value
            End If

            cmbParam(2) = New SqlParameter("@_POSITION_NAME", SqlDbType.VarChar)
            If _POSITION_NAME.Trim <> "" Then 
                cmbParam(2).Value = _POSITION_NAME
            Else
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbPositionLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        Private ReadOnly Property SqlInsert() As String 
            Get
                ...
                Sql += " OUTPUT INSERTED.ID, INSERTED.POSITION_CODE, INSERTED.POSITION_NAME, INSERTED.CREATEBY, INSERTED.CREATEON, INSERTED.UPDATEBY, INSERTED.UPDATEON
                Sql += " VALUES("
                sql += "@_ID" & ", "
                sql += "@_POSITION_CODE" & ", "
                sql += "@_POSITION_NAME" & ", "
        ...
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "POSITION_CODE = " & "@_POSITION_CODE" & ", "
        ...
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, POSITION_CODE, POSITION_NAME, CREATEBY, CREATEON, UPDATEBY, UPDATEON FROM " & tableName
                Return Sql
            End Get
        End Property
