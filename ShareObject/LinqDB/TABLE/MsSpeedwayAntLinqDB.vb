...
Namespace TABLE
    'Represents a transaction for MS_SPEEDWAY_ANT table LinqDB.
    '[Create by  on March, 13 2015]
    Public Class MsSpeedwayAntLinqDB
        Public sub MsSpeedwayAntLinqDB()

        End Sub 
        ' MS_SPEEDWAY_ANT
        Const _tableName As String = "MS_SPEEDWAY_ANT"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into MS_SPEEDWAY_ANT table successfully.
        ...
        '/// Returns an indication whether the current data is updated to MS_SPEEDWAY_ANT table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from MS_SPEEDWAY_ANT table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of MS_SPEEDWAY_ANT by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of MS_SPEEDWAY_ANT by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As MsSpeedwayAntLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of MS_SPEEDWAY_ANT by specified MS_SPEEDWAY_ID_PORT_NUMBER key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of MS_SPEEDWAY_ANT by specified MS_SPEEDWAY_ID_PORT_NUMBER key is retrieved successfully.
        '/// <param name=cMS_SPEEDWAY_ID_PORT_NUMBER>The MS_SPEEDWAY_ID_PORT_NUMBER key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of MS_SPEEDWAY_ANT by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As MsSpeedwayAntLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table MS_SPEEDWAY_ANT
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (CREATED_BY, CREATED_DATE, UPDATED_BY, UPDATED_DATE, MS_SPEEDWAY_ID, PORT_NUMBER, IS_ENABLED, TX_POWER_IN_DBM, RX_SENSITIVITY_IN_DBM, BRAND_NAME, MODEL_NAME)"
                Sql += " OUTPUT INSERTED.ID, INSERTED.CREATED_BY, INSERTED.CREATED_DATE, INSERTED.UPDATED_BY, INSERTED.UPDATED_DATE, INSERTED.MS_SPEEDWAY_ID, INSERTED.PORT_NUMBER, INSERTED.IS_ENABLED, INSERTED.TX_POWER_IN_DBM, INSERTED.RX_SENSITIVITY_IN_DBM, INSERTED.BRAND_NAME, INSERTED.MODEL_NAME
                Sql += " VALUES("
                sql += "@_CREATED_BY" & ", "
                sql += "@_CREATED_DATE" & ", "
                sql += "@_UPDATED_BY" & ", "
        ...
        'Get update statement form table MS_SPEEDWAY_ANT
        ...
        'Get Delete Record in table MS_SPEEDWAY_ANT
        ...
        'Get Select Statement for table MS_SPEEDWAY_ANT
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATED_BY, CREATED_DATE, UPDATED_BY, UPDATED_DATE, MS_SPEEDWAY_ID, PORT_NUMBER, IS_ENABLED, TX_POWER_IN_DBM, RX_SENSITIVITY_IN_DBM, BRAND_NAME, MODEL_NAME FROM " & tableName
                Return Sql
            End Get
        End Property
