...
Namespace TABLE
    'Represents a transaction for TB_OFFICER_MENU table LinqDB.
    '[Create by  on January, 15 2015]
    Public Class TbOfficerMenuLinqDB
        Public sub TbOfficerMenuLinqDB()
       ...
       'Define Public Method 
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbOfficerMenuLinqDB
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByMENU_ID_OFFICER_ID(cMENU_ID As Long, cOFFICER_ID As Long, trans As SQLTransaction) As Boolean
            Return doChkData("MENU_ID = " & DB.SetDouble(cMENU_ID) & " AND OFFICER_ID = " & DB.SetDouble(cOFFICER_ID), trans)
        End Function

        '/// Returns an duplicate data record of TB_OFFICER_MENU by specified MENU_ID_OFFICER_ID key is retrieved successfully.
        '/// <param name=cMENU_ID_OFFICER_ID>The MENU_ID_OFFICER_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByMENU_ID_OFFICER_ID(cMENU_ID As Long, cOFFICER_ID As Long, cid As Long, trans As SQLTransaction) As Boolean
            Return doChkData("MENU_ID = " & DB.SetDouble(cMENU_ID) & " AND OFFICER_ID = " & DB.SetDouble(cOFFICER_ID) & " And id <> " & DB.SetDouble(cid) & " ", trans)
        End Function
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbOfficerMenuLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        Private ReadOnly Property SqlInsert() As String 
            Get
                ...
                Sql += " OUTPUT INSERTED.ID, INSERTED.OFFICER_ID, INSERTED.MENU_ID, INSERTED.CREATEBY, INSERTED.CREATEON, INSERTED.UPDATEBY, INSERTED.UPDATEON
                Sql += " VALUES("
                sql += "@_ID" & ", "
                sql += "@_OFFICER_ID" & ", "
                sql += "@_MENU_ID" & ", "
        ...
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, OFFICER_ID, MENU_ID, CREATEBY, CREATEON, UPDATEBY, UPDATEON FROM " & tableName
                Return Sql
            End Get
        End Property
