...
Namespace ConnectDB
    Public Class TransactionDB
        ...
        Public Function CreateTransaction(db As SelectDB) As Boolean
            Dim ret As Boolean = True
            Try
                ...
                If _conn Is Nothing Then
                    If db = SelectDB.DIPRFID Then
                        _conn = DIPRFIDSqlDB.GetConnection
                    ElseIf db = SelectDB.PATENDB Then
                        _conn = PatentSqlDB.GetConnection
                    ElseIf db = SelectDB.FaultMng Then
                        _conn = FaultMngSqlDB.GetConnection
                    ElseIf db = SelectDB.QDIPAEC Then
                        _conn = QDIPAECDB.GetConnection
                    End If
                End If
        ...
        Public Function CreateTransaction(ByVal connectionString As String, db As SelectDB) As Boolean
            Dim ret As Boolean = True
            Try
                If _conn IsNot Nothing Then
                    _conn.Close()
