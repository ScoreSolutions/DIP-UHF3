...
Namespace ConnectDB
    Public MustInherit Class SqlDB
        ...
        Protected Shared Function GetNextID(ByVal fldName As String, ByVal tbName As String, ByVal trans As SqlTransaction, ConnStr As String) As Long
            Dim ret As Long
...
#Region "Execure Table"
        Friend Shared Function ExecuteTable(ByVal sql As String, ByVal conn As SqlConnection, ByVal trans As SqlTransaction, cmdParam() As SqlParameter, ConnStr As String) As DataTable
...
#End Region
        ...
        Friend Shared Function GetConnection(ByVal connString As String) As SqlConnection
