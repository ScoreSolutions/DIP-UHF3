<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmReturnByDate.aspx.vb" Inherits="frmReturnByDate" %>
 ...
 <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">รายงานการคืนแฟ้มประจำวัน</li>
            </ul>
            <!--.breadcrumb-->
        ...
        <div class="page-content">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="row-fluid">
                        <h3 class="header smaller lighter blue">รายงานการคืนแฟ้มประจำวัน</h3>
