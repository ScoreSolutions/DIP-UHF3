<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmGraphAll.aspx.vb" Inherits="frmGraphAll" %>
...
<div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">กราฟแสดงรายการยืม-คืนแฟ้ม(ทั้งหมด)</li>
            </ul>
            <!--.breadcrumb-->
        ...
        <div class="page-content">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="row-fluid">
                        <h3 class="header smaller lighter blue">กราฟแสดงรายการยืม-คืนแฟ้ม(ทั้งหมด)</h3>
