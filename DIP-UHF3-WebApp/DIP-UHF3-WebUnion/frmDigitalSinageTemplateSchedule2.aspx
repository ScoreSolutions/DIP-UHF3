<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage2.master" AutoEventWireup="false" CodeFile="frmDigitalSinageTemplateSchedule2.aspx.vb" Inherits="frmDigitalSinageTemplateSchedule2" %>
    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Digital Signage Template Schedule</li>
            </ul>
        ...
        <div class="page-content">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <!--PAGE CONTENT BEGINS-->
                    <h3 class="header smaller lighter blue">Digital Signage Template Schedule</h3>
                        ...
                        <div class="span12" id="divbtnAdd">
                            ...
                            <button class="btn btn-small" id="btnBack" name="btnBack">
                                ...
                                Back
                                      ...
                                      <%--   <button class="btn btn-small" id="btnSelect" name="btnSelect">
                                <i class=" icon-undo"></i>
                                Get Select Muti Box
                            </button>--%>
                    ...
                    <div id="dialog-grid">
                        <div class="row-fluid">
                            <div class="span12">
                                <table class="table table-bordered table-hover" id="dt_out"></table>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="dialog-edit">
                       <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="span2">
                                    <label class="control-label" id="lblScheduleName">Schedule Name</label>
                                </div>
                                <div class="span10">
                                    <input type="text" class="input-mini" id="txtSceduleName" style="width: 385px;" maxlength="255" />
                                    <span class="help-inline color red" id="lblvalidSceduleName" style="display: none">This field is required</span>
                                </div>
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="span2">
                                    <label class="control-label" id="lblSinageContent">Signage Content</label>
                                </div>
                                <div class="span10">
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span1" >
                                <input type="text" class="input-mini" id="txtAutoStopDuration" style="width: 65px;" onkeypress="return Numbers(event)" maxlength="5" />

                            </div>
                            <div class="span1" style="margin-right:0px">
                                <label class="control-label" id="lblAutoStopDurationMS">Minute</label>
                            </div>
                            <div class="span2" style="margin: 0px">
                         ...
                         <div class="row-fluid">
                             <div class="span12">
                                 <span class="help-inline color red" id="lblvalid_SinageContent" style="display: none">Please specify Signage Content</span>
                                 <span class="help-inline color red" id="lblvalidDuration" style="display: none">Please specify Duration</span>
                                <span class="help-inline color red" id="lblvalidExistContent" style="display: none">This Signage Content is already exist.</span>
...
<script type="text/javascript">
    ...
    //Call
    function LoadData() {
        var dataurl = 'WebService/WebService.asmx/LoadSinageScheduleAll';
        $.ajax({
            "type": "POST",
            "dataType": 'json',
    ...
    function PopulateGrid(jsondata) {
        ...
        var columns = [
                        ...
                        {
                            "sTitle": "Schedule Name",
                            "sType": "string",
                            "sDefaultContent": "",
                            "mDataProp": "schedule_name"
        ...
        oTable = $('#dt_out').dataTable({
            ...
            "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                var current_schedule = aData.current_schedule;
                if (current_schedule != '0') {
                    $(nRow).css('background-color', '#54C571');
    ...
    function onEdit(id) {
        ...
        $.ajax({
            type: "POST",
            url: "WebService/WebService.asmx/LoadSinageScheduleID",
            data: param,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (data) {
                ...
                if (strvalue.length == 1) {
                    ...
                    $("#txtSceduleName").val(strvalue[0].schedule_name);
                    //$("#cbSinageContent").val(strvalue[0].ms_signage_content_template_id);
    ...
    function LoadSchedul(id) {
        var param = "{'ms_signage_template_schedule_id':" + JSON.stringify(id) + "}";
        $.ajax({
            type: "POST",
            url: "WebService/WebService.asmx/LoadSinageScheduleDailyByTemplateID",
            data: param,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (data) {
        ...
        $.ajax({
            type: "POST",
            url: "WebService/WebService.asmx/LoadSinageScheduleWeeklyByTemplateID",
            data: param,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (data) {
    ...
    function onSave() {
        ...
        var login_username = $('#' + '<%=Master.FindControl("lblUserName").ClientID%>').text();
            var schedule_name = $('#txtSceduleName').val();
            //var ms_signage_content_template_id = $("#cbSinageContent").val();
            ...
            var param = "{'id':" + JSON.stringify(id)
                + ",'schedule_name':" + JSON.stringify(schedule_name)
                //+ ",'ms_signage_content_template_id':" + JSON.stringify(ms_signage_content_template_id)
            ...
            $.ajax({
                type: "POST",
                url: "WebService/WebService.asmx/SaveSinageSchedule",
                data: param,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: onSuccess,
    ...
    function populatesignagecontent(ms_signage_template_schedule_id) {
       
        var strselect;
        var param = "{'ms_signage_template_schedule_id':" + JSON.stringify(ms_signage_template_schedule_id) + "}";
        $selectSinageContent = $("#cbSinageContent");
        $.ajax({
            type: "POST",
            url: 'WebService/WebService.asmx/LoadSignageContentBySignageSchedule',
            data: param,
            dataType: 'JSON',
            contentType: "application/json; charset=utf-8",
            success: function (data) {
                var jsonobject = JSON.parse(data.d);
                $selectSinageContent.html('');
                $selectSinageContent.append('<option value="">Choose a Signage Content</option>');
                //append a select option
                $.each(jsonobject, function (key, val) {
                    strselect = '';
                    if (val.id == ms_signage_template_schedule_id) {
                     
                        strselect = ' selected="' + val.selected + '"';
                    }

                    $selectSinageContent.append('<option value="' + val.id + '" ' + strselect + '>' + val.template_name + '</option>');
                    $selectSinageContent.trigger("chosen:updated");//update select option
                })
                $selectSinageContent.chosen();
            }
        });
    }

        function populateSelect(ms_signage_template_schedule_id) {
            ...
            $.ajax({
                type: "POST",
                url: 'WebService/WebService.asmx/LoadMonthByDigitalSinageTemplateSchedule',
                data: param,
                dataType: 'JSON',
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                url: 'WebService/WebService.asmx/LoadDayByDigitalSinageTemplateSchedule',
                data: param,
                dataType: 'JSON',
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                url: 'WebService/WebService.asmx/LoadLEDTVBySinageSchedule',
                data: param,
                dataType: 'JSON',
                contentType: "application/json; charset=utf-8",
                success: function (data) {
        ...
        function onDelete(id) {
            ...
            $.ajax({
                type: "POST",
                url: "WebService/WebService.asmx/DeleteSinageSchedule",
                data: param,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function onSuccess(result) {
            if (result.d == "YES") {
                ...
                if (result.d == "DUPLICATESCHEDULENAME") {
                    onAlert("Schedule name already exists. Please modify schedule name.");
                    LoadData();
                }
                else if (result.d == "DUPLICATESCHEDULESTARTDATE") {
                    onAlert("Start time already exists. Please change start time.");
                    LoadData();
                }
                else {
                    var data = result.d;
        ...
        function onValidHide() {
            $("#lblvalidSceduleName").hide();
           // $("#lblvalid_SinageContent").hide();
            $("#lblvalid_LEDTV").hide();
        ...
        function onValid() {
            ...
            var isValid;
            isValid = true;
            var SchedulName = $('#txtSceduleName').val();
            //var SinageContent = $("#cbSinageContent").val();
...
<script type="text/javascript">
    ...
    function onSaveTime(id) {
        ...
        var signage_content = $("#cbSinageContent").val();
        var signage_content_name = $("#cbSinageContent>option:selected").text();
        var duration = $("#txtAutoStopDuration").val();
        ...
        if (id == 0) {
            aaData.push({
                ...
                "ms_signage_content_template_id": signage_content,
                "template_name": signage_content_name,
            ...
            for (var i = 0; i < aaData.length; i++) {
                if (aaData[i].id == id) {
                    aaData[i].ms_signage_content_template_id = signage_content;
                    aaData[i].template_name = signage_content_name;
                    aaData[i].duration_minute = duration;
                    break;
                }
            }
        }
    ...
    function onValidTimePeriod() {
        ...
        var dataurl = 'WebService/WebService.asmx/CheckSinageScheduleTime';
        $.ajax({
            "type": "POST",
            "dataType": 'json',
            "contentType": "application/json; charset=utf-8",
    ...
    function LoadSchedultime(id) {
        var param = "{'ms_signage_template_schedule_id':" + JSON.stringify(id) + "}";
        var dataurl = 'WebService/WebService.asmx/LoadSinageScheduleTimeByTemplateID';
        $.ajax({
            "type": "POST",
            "dataType": 'json',
            "contentType": "application/json; charset=utf-8",
    ...
    function PopulateGridSchedultime(jsondata) {
        ...
        var columns = [
                        ...
                        //{
                        //    "sTitle": "Signage Content ID",
                        //    "sType": "string",
                        //    "sDefaultContent": "",
                        //    "mDataProp": "ms_signage_content_template_id"

                        //},
                        {
                            "sTitle": "Signage Content",
                            "sType": "string",
                            "sDefaultContent": "",
                        ...
                        {
                            "sTitle": "Duration(Minute)",
                            "sType": "string",
                            "sDefaultContent": "",
                            "mDataProp": "duration_minute"
    ...
    function onEditTime(id) {
        ...
        if (id > 0) {
            ...
            $.each(editjsonobject, function (key, val) {
                ...
                $("#cbSinageContent").val(val.ms_signage_content_template_id);
                $('#txtAutoStopDuration').val(val.duration_minute);
                populatesignagecontent(val.ms_signage_content_template_id);
            })
    ...
    function onValidTimeHide() {
        ...
        $("#lblvalid_SinageContent").hide();
        $("#lblvalidDuration").hide();
        $("#lblvalidExistContent").hide();
    ...
    function onValidTime() {
        ...
        var content_name = $("#cbSinageContent>option:selected").text();
        if (checkid_duplicate_sinage(content_name, $('#HiddenTimeId').val()) == false) {
            $("#lblvalidExistContent").show();
            return false;
        }
        else {
            $("#lblvalidExistContent").hide();
    ...
    function checkid_duplicate_sinage(content_name, id) {
        var jsonobject = JSON.parse(localStorage['schedultime']);
        var checkjsonobject = getObjects(jsonobject, 'template_name', content_name);
