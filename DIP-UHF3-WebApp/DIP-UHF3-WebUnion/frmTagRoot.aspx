<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmTagRoot.aspx.vb" Inherits="frmTagRoot" %>
        ...
        <div class="main-content">
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">ประวัติการเคลื่อนย้าย</li>
                </ul>
                <!--.breadcrumb-->
            ...
            <div class="page-content">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <div class="row-fluid">
                            <h3 class="header smaller lighter blue">ประวัติการเคลื่อนย้าย</h3>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:Label ID="lblseq" runat="server" Text='<%# bind("seq") %>' />
                                                 ...
                                                 <asp:TemplateField HeaderText="เลขที่แฟ้ม" >
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblTag" runat="server" Text='<%# Bind("tag")%>' />
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="ประตู" >
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblgate" runat="server" Text='<%# Bind("gate")%>' />
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="วันที่ - เวลา" >
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbldatetime" runat="server" Text='<%# Bind("datetime")%>' />
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                </asp:TemplateField>
