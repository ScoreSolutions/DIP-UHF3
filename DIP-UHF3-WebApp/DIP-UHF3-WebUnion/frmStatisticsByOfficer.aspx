<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmStatisticsByOfficer.aspx.vb" Inherits="frmStatisticsByOfficer" %>
...
<div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">รายงานประวัติการยืม-คืนแฟ้ม(รายบุคคล)</li>
            </ul>
            <!--.breadcrumb-->
        ...
        <div class="page-content">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="row-fluid">
                        <h3 class="header smaller lighter blue">รายงานประวัติการยืม-คืนแฟ้ม(รายบุคคล)</h3>
   ...
   <script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        function populateSearch() {
            ...
            var reportname = 'frmStatisticsByOfficer';
            ...
            var para = hostreport + '?reportname=' + reportname + '&officerid=' + officerid + '&officername=' + officername + '&datefrom=' + datefrom + '&dateto=' + dateto + '&fullname=' + fullname;
