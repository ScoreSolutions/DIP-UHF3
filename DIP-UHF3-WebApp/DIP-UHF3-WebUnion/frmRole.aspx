<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage2.master" AutoEventWireup="false" CodeFile="frmRole.aspx.vb" Inherits="frmRole" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="main-content">
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Role and Responsibility</li>
                </ul>
                <!--.breadcrumb-->
            ...
            <div class="page-content">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <!--PAGE CONTENT BEGINS-->
                        <h3 class="header smaller lighter blue">Role and Responsibility</h3>

                        <div class="row-fluid">

                            <div class="span7" id="divgroup">
                                <h4 class="user color pink">Role</h4>
                                <div class="row-fluid">
                                    <div class="span12">
                                ...
                                <div class="tabbable">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div id="profile" class="tab-pane">
                                            <div class="row-fluid">
                                                <div class="span7">
                                                    <input type="text" id="txtUserName" style="width: 250px" placeholder="Input name or surname and select.....">
            ...
            <div id="dialog-edit" style="display: none;">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <!--PAGE CONTENT BEGINS-->
                        <div class="span4">
                            <label class="control-label" id="lblGroupName">Role Name</label>
                        </div>
                        <div class="span8">

                            <input type="text" id="txtGroupName" placeholder="Role Name" class="span12 limited" data-maxlength="50" maxlength="50">
                ...
                <div class="row-fluid" >
                    <div class="span12">
                        <!--PAGE CONTENT BEGINS-->
                        <div class="span4">
                            <label class="control-label" id="lblGroupDesc">Description</label>
                        </div>
                        <div class="span8">
                            <textarea id="txtGroupDesc" placeholder="Description" style="height: 120px; resize: none;" class="span12 limited" data-maxlength="255" maxlength="255"></textarea>
    ...
    <div class="span8">
            ...
            <link href="assets2/js/jquery.dynatree-1.2.6-all/skin/ui.dynatree.css" rel="stylesheet" />
            <script src="assets2/js/jquery.dynatree-1.2.6-all/jquery.dynatree.js"></script>
            ...
            <script type="text/javascript">
                ...
                $.ajax({
                    type: "POST",
                    url: "WebService/WebService.asmx/SaveAuthorizeGroup",
                    data: param,
            ...
            function onSaveGroup(id) {
                ...
                $.ajax({
                    type: "POST",
                    url: "WebService/WebService.asmx/SaveGroup",
                    data: param,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
            ...
            function onSaveGroupUser() {
                ...
                $.ajax({
                    type: "POST",
                    url: "WebService/WebService.asmx/SaveGroupUser",
                    data: param,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
    ...
    function onDeleteGroup(id) {
        ...
        $.ajax({
            type: "POST",
            url: "WebService/WebService.asmx/DeleteGroup",
            data: param,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
    ...
    function onDeleteGroupUser(id) {
        ...
        $.ajax({
            type: "POST",
            url: "WebService/WebService.asmx/DeleteGroupUser",
            data: param,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
    ...
    function onGroupSuccess(result) {
        ...
        if (result.d == "YES") {
            ...
            if (result.d == "DUPLICATE") {
                onAlert("Role name already exists. Please modify role name.");
                LoadData();
            } else {
                onAlert("Save data fail");
            }
    ...
    function onGroupUserSuccess(result) {
        ...
        if (result.d == "YES") {
            ...
            if (result.d == "DUPLICATE") {
                onAlert("User already exists  in group. Please modify user.");
                LoadDataUser();
            } else {
                onAlert("Save data fail");
            }
    ...
    function onDeleteSuccess(result) {
        ...
        if (result.d == true) {
            onAlert("Delete data complete");
            $("#divmenuaccess").hide();
            $("#divgroup").removeClass("span6");
            $("#divgroup").addClass("span12");
            $("#divmenuaccess").removeClass("span6");
           // $("#divmenuaccess").addClass("span5");
            LoadData();

        } else {
            onAlert("Delete data fail");
        }
    ...
    //Grid
    function LoadData() {
        var dataurl = 'WebService/WebService.asmx/LoadGroupPermissionAll';
        $.ajax({
            "type": "POST",
            "dataType": 'json',
            "contentType": "application/json; charset=utf-8",
...

                        {
                            ...
                            "fnRender": function (obj) {
                                return '<div class="hidden-phone visible-desktop action-buttons">'
                                        + '<a href="#"  data-toggle="modal" class="blue"  title="Authorized" onClick="onMapmenu(' + obj.aData.id + '); return false;">'
                                        ...
                                        + '</a>'
                                        + '&nbsp;'
                                        + '<a href="#"  class="Red"  title="Delete" onclick="onConfirmDeleteGroup(' + obj.aData.id + '); return false;" >'
                                        ...
                                        + '					<li>'
                                        + '						<a href="#"  class="tooltip-info" data-rel="tooltip" title="Authorized" onClick="onMapmenu(' + obj.aData.id + '); return false;">'
                                        + '							<span class="blue">'
                                        ...
                                        + ''
                                        + '					<li>'
                                        + '						<a href="#"  class="tooltip-error" data-rel="tooltip" title="Delete" onclick="onConfirmDeleteGroup(' + obj.aData.id + '); return false;">'
                                        + '							<span class="red">'
    ...
    function LoadDataUser() {
        ...
        var dataurl = 'WebService/WebService.asmx/GetUserMapAuthorizeGroup';
        $.ajax({
            "type": "POST",
            "dataType": 'json',
            "contentType": "application/json; charset=utf-8",
            ...
            "bSortable": false
...

                        {
                            ...
                            "fnRender": function (objUser) {
                                return '<div class="hidden-phone visible-desktop action-buttons">'
                                        + '<a href="#"  class="Red"  title="Delete" onclick="onConfirmDeleteGroupUser(' + objUser.aData.id + '); return false;" >'
                                        + '<span class="red"><i class="icon-trash bigger-130"></i></span>'
                                        + '</a>'
                                        + '</div>'
                                                    + '<div class="hidden-desktop visible-phone">'
                                        ...
                                        + ''
                                        + '					<li>'
                                        + '						<a href="#"  class="tooltip-error" data-rel="tooltip" title="Delete" onclick="onConfirmDeleteGroupUser(' + objUser.aData.id + '); return false;">'
                                        + '							<span class="red">'
                                        + '								<i class="icon-trash bigger-120"></i>'
                                        + '							</span>'
                                        + '						</a>'
    ...
    function onEdit(id) {
        ...
        $.ajax({
            type: "POST",
            url: "WebService/WebService.asmx/LoadAuthorizeGroup",
            data: param,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
    ...
    function onMapmenu(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                var strvalue = JSON.parse(data.d);
                if (strvalue.length == 1) {
                    $("#lblMenuheader").text('Responsibility ' + '( Role : ' + strvalue[0].group_name + ' )');
                } else {
                    $("#lblMenuheader").text("");
                }
            }
        ...
        $("#txtUserName").autocomplete({
            ...
            source: function (request, response) {
                $.ajax({
                    type: "POST",
                    url: "WebService/WebService.asmx/LoadUserDeaprtByName",
                    data: "{ 'name': '" + request.term + "','department_id': '' }",
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
        ...
        //Set Class 2 Side
        $("#divgroup").removeClass("span12");
        $("#divgroup").addClass("span6")
       // $("#divmenuaccess").removeClass("span1");
        $("#divmenuaccess").addClass("span6");
    ...
    function populatelistmenu() {
        ...
        $("#tree1").dynatree({
            ...
            initAjax: {
                type: "POST",
                url: "WebService/WebService.asmx/LoadAuthorizeGroupMap",
                data: paramsend,
                contentType: "application/json; charset=utf-8",
                dataType: "json"
            },
        ...
        $.ajax({
            type: "POST",
            url: "WebService/WebService.asmx/GetAuthorizeGroupMap",
            data: paramsend,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
