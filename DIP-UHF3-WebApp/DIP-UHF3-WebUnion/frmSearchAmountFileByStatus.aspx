<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmSearchAmountFileByStatus.aspx.vb" Inherits="frmSearchAmountFileByStatus" %>
...
<%--    <style>
    ...
    <script src="assets/js/iconv.js-master/src/iconv.js"></script>
    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">จำนวนแฟ้มแยกตามสถานะ</li>
            </ul>
            <!--.breadcrumb-->
        ...
        <div class="page-content">
            <div class="row-fluid">
                <div class="span12">
                    <!--PAGE CONTENT BEGINS-->
                    <h3 class="header smaller lighter blue">จำนวนแฟ้มแยกตามสถานะ</h3>
                    <div class="row-fluid">
                        <div class="span2">
    ...
    <script type="text/javascript">
        ...
        function LoadData(isshow) {
            ...
            var status_name = $("#cbStatus").val();
            var patent_type_id = $("#cbPatentType").val();

            var param = "{'status_name':" + JSON.stringify(status_name)
            ...
            $.ajax({
                type: "POST",
                url: "WebService/WebService.asmx/LoadSearchAmountFileByStatus",
                data: param,
        ...
        function populateExport() {
            var status_name = $("#cbStatus").val();
            var sts = JSON.stringify(status_name);
            var patent_type_id = $("#cbPatentType").val();
            var para = '?status_name=' + encodeURIComponent(status_name) + '&patent_type_id=' + patent_type_id + '&isshow=1';
            var dataurl = 'frmSearchAmountFileByStatus_Report.ashx' + para;

           // var test = encodeURIComponent(status_name);
            //alert('encode:'+test);
            //alert('decode:' + decodeURIComponent(test));
