<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage2.master" AutoEventWireup="false" CodeFile="frmDigitalSinageTemplateSchedule.aspx.vb" Inherits="frmDigitalSinageTemplateSchedule" %>
...
<script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //    //array
            //   // var values = $("#cbMonths>option:selected").map(function () { return $(this).val(); });
...
<script type="text/javascript">
        ...
        //function populateSelectLEDTVById() {
        //    var param = "{'ms_signage_template_id_default':" + JSON.stringify($("#cbSinageContent").val()) + "}";
        //    $selectLEDTV = $("#cbLEDTV");
        //    $.ajax({
        //        type: "POST",
        //        url: 'WebService/WebService.asmx/LoadLEDTVIDBySinageContent',
        //        data: param,
        //        dataType: 'JSON',
        //        contentType: "application/json; charset=utf-8",
        //        success: function (data) {
