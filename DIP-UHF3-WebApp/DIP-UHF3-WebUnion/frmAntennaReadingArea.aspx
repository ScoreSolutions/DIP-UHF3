<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage2.master" AutoEventWireup="false" CodeFile="frmAntennaReadingArea.aspx.vb" Inherits="frmAntennaReadingArea" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <%--                  <div class="row-fluid">
            ...
            <div id="dialog-image" style="display: none">
                <img id="imgPopup" src="images/No_image.gif" style="height: 350px; width: 740px;" />
            </div>
        </div>
        ...
        <div class="row-fluid">
            ...
            <div class="span4">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span8">
                        <input type="text" class="input-mini" id="txtReaderID" maxlength="255" disabled="disabled" style="width: 250px;" />
                ...
                <div class="row-fluid">
                    ...
                    <div class="span8">
                        <input type="text" class="input-mini" id="txtIPAddress" maxlength="255" disabled="disabled" style="width: 250px;" />
                    </div>
                </div>
                <div class="row-fluid">
                    <div class="span4">
                    ...
                    <div class="span8">
                        <input type="text" class="input-mini" id="txtInstallPosition" maxlength="255" disabled="disabled" style="width: 250px;" />
                    </div>
                </div>
                <div class="row-fluid">
                    <div class="span4">
                    ...
                    <div class="span8">
                        <select id="cboant" data-placeholder="Choose a Antenna..." style="width: 250px;">
                        </select>
                    </div>
            </div>
            ...
            <div class="row-fluid">
                ...
                <div class="span8">
                    <select id="cbofficermapLayout" data-placeholder="Choose a Grid Layout..." style="width: 250px;">
                    </select>
                </div>
            </div>
            <div class="row-fluid">
    ...
    <script type="text/javascript">
        ...
        function onLoadImage(id) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.d != "") {
                        $("#imgPopup").attr("src", data.d).width(740);
                        $("#dialog-image").dialog({
                            autoOpen: false,
                            resizable: false,
                            width: "740px",
