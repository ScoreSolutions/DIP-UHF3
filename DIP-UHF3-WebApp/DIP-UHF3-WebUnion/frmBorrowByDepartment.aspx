<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmBorrowByDepartment.aspx.vb" Inherits="frmBorrowByDepartment" %>
   ...
   <div class="main-content">
                    <div class="breadcrumbs" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">รายงานการยืมแฟ้ม(ตามสังกัด)</li>
                        </ul>
                        <!--.breadcrumb-->
                    ...
                    <div class="page-content">
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="row-fluid">
                                    <h3 class="header smaller lighter blue">รายงานการยืมแฟ้ม(ตามสังกัด)</h3>
        ...
        <script type="text/javascript">
            ...
            function comparedate(strdatefrom, strdateto) {
                ...
                if (strdatefrom != '' && strdateto != '') {
                    ...
                    //var from = datefromarr[2] + '-' + datefromarr[1] + '-' + datefromarr[0];
                    //var to =  datetoarr[2] + '-' + datetoarr[1] + '-' + datetoarr[0];
                    //alert(from);
                    //alert(to);
            ...
            function populateSearch() {
                ...
                var reportname = 'frmBorrowByDepartment';
                var departmentname = $("#cbDepartment option:selected").text()
                ...
                var para = hostreport + '?reportname=' + reportname + '&departmentname=' + departmentname + '&departmentid=' + departmentid + '&datefrom=' + datefrom + '&dateto=' + dateto + '&statusreturntype=' + borrowType + '&fullname=' + fullname;
