<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmBorrowAllOfficer.aspx.vb" Inherits="frmBorrowAllOfficer" %>
...
<div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">รายงานการยืมแฟ้มที่ติดชื่อผู้ยืมทั้งหมด</li>
            </ul>
            <!--.breadcrumb-->
        ...
        <div class="page-content">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="row-fluid">
                        <h3 class="header smaller lighter blue">รายงานการยืมแฟ้มที่ติดชื่อผู้ยืมทั้งหมด</h3>
    ...
    <script type="text/javascript">
        ...
        function populateSearch() {
            ...
            var reportname = 'frmBorrowWithName';
            var datefrom = $('#datefrom').val();
            var dateto = $('#dateto').val();
            var fullname = encodeURIComponent($('#' + '<%=Master.FindControl("lblfullname").ClientID%>').text());

            var para = hostreport + '?reportname=' + reportname + '&datefrom=' + datefrom + '&dateto=' + dateto + '&fullname=' + fullname;
