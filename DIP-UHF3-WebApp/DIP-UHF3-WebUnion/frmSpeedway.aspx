<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage2.master" AutoEventWireup="false" CodeFile="frmSpeedway.aspx.vb" Inherits="frmSpeedway" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="main-content">
                ...
                <div class="page-content">
                    <div class="row-fluid">
                        <div class="span12">
                            <!--PAGE CONTENT BEGINS-->
                            <h3 class="header smaller lighter blue">RFID</h3>
                            ...
                            <div id="dialog-edit">
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span2">
                                        <label class="control-label" for="lblReaderID">Mac Address</label>
                                    </div>
                                    <div class="span4">
                                        <input type="text" id="txtMacAddress" style="width: 200px;" >
                                        <span class="help-inline color red" id="lblvalidMacAddress" style="display: none">This field is required</span>
                                    </div>
                                </div>
                                <div class="row-fluid">
                                    <div class="span2">
                                  ...
                                  <%--  <div>
                                    ...
                                    <div class="row-fluid">
                                        <div class="span12">
                                            ...
                                            <div class="span10">
                                                <input type="text" id="txtInstallPosition" style="width: 392px">
                                    ...
                                    <div class="row-fluid">
                                        <div class="span12">
                                            ...
                                            <div class="span10">
                                                ...
                                                <span class="help-inline color red" id="lblvalid_Label" style="display: none">This field is required</span>
                                            </div>
                            ...
                            <div id="dialog-edit-antenna">
                                <div class="row-fluid">
                                    <div class="span12">
                                        ...
                                        <div class="span9">
                                            <input type="text" class="input-mini" id="txtPortNumber" style="width: 150px;" onkeypress="return Numbers(event)" maxlength="5" />
                                ...
                                <div class="row-fluid">
                                    <div class="span12">
                                        ...
                                        <div class="span4" >
                                            <input type="text" class="input-mini" id="txtTxPower" style="width: 150px;" onkeypress="return FloatNumbers(event)" maxlength="20" />
                                            
                                        </div>
                                        <div class="span1" style="margin:0px">
                                             <label class="control-label" id="lblTxPowerdbm">Dbm</label>
                                        </div>
                                ...
                                <div class="row-fluid">
                                    <div class="span12">
                                        ...
                                        <div class="span4">
                                            <input type="text" class="input-mini" id="txtRxSensitivity" style="width: 150px;" onkeypress="return ChkMinusDbl(txtRxSensitivity,event)" maxlength="20" />
                                        </div>
                                         <div class="span1" style="margin:0px">
                                              <label class="control-label" id="lblRxSensitivitydbm">Dbm</label>
                                         </div>
                                         <div class="span4" style="margin:0px">
                            ...
                            <div id="dialog-edit-gpi">
                                <div class="row-fluid">
                                    <div class="span12">
                                        ...
                                        <div class="span9">
                                            ...
                                            <span class="help-inline color red" id="lblvalid_PortNumberGPI" style="display: none">This field is required</span>
                                        </div>
                                ...
                                <div class="row-fluid">
                                    <div class="span12">
                                        ...
                                        <div class="span4" style="margin:0px">
                                             <span class="help-inline color red" id="lblvalid_Debounce" style="display: none">This field is required</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row-fluid">
    ...
    <script type="text/javascript">
        ...
        function LoadData() {
            var dataurl = 'WebService/WebService.asmx/LoadSpeedwayAll';
            $.ajax({
                "type": "POST",
                "dataType": 'json',
        ...
        function onEdit(id) {
            ...
            $.ajax({
                type: "POST",
                url: "WebService/WebService.asmx/LoadSpeedwayByID",
                data: param,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function onSave() {
            ...
            $.ajax({
                type: "POST",
                url: "WebService/WebService.asmx/SaveSpeedway",
                data: param,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: onSuccess,
        ...
        function onDelete(id) {
            ...
            $.ajax({
                type: "POST",
                url: "WebService/WebService.asmx/DeleteSpeedway",
                data: param,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
   ...
   <%--populateselect--%>
    <script type="text/javascript">
        ...
        function populateSelect(speedway_id) {
           
            var strselect;
            var param = "{'speedway_id':" + JSON.stringify(speedway_id) + "}";

            $select = $("#cbfloor");
            $.ajax({
                type: "POST",
                url: 'WebService/WebService.asmx/LoadFloorBySpeedway',
                data: param,
                dataType: 'JSON',
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                url: 'WebService/WebService.asmx/LoadRoomBySpeedway',
                data: param,
                dataType: 'JSON',
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                url: 'WebService/WebService.asmx/LoadObjectveBySpeedway',
                data: param,
                dataType: 'JSON',
                contentType: "application/json; charset=utf-8",
                success: function (data) {
    ...
    <script type="text/javascript">
        ...
        function LoadDataAntenna(id) {
            var param = "{'id':" + JSON.stringify(id) + "}";
            var dataurl = 'WebService/WebService.asmx/LoadSpeedwayAntenna';
            $.ajax({
                "type": "POST",
                "dataType": 'json',
                "contentType": "application/json; charset=utf-8",
                            ...
                            },
                            {
                                ...
                                "fnRender": function (obj) {
                                    ...
                                    return '<div class="hidden-phone visible-desktop action-buttons">'
                                            ...
                                            + '</a>'
                                            + '&nbsp;'
                                            + '<a href="#"   class="Red"  title="Delete" onclick="onConfirmDeleteAntenna(' + obj.aData.no + '); return false;"' + str + ' >'
                                            + '<span class="red"><i class="icon-trash bigger-130"></i></span>'
                                            + '</a>'
                                            + '</div>'
                                            + '<div class="hidden-desktop visible-phone">'
                                            ...
                                            + ''
                                            + '					<li>'
                                            + '						<a href="#"   class="tooltip-error" data-rel="tooltip" title="Delete" onclick="onConfirmDeleteAntenna(' + obj.aData.no + '); return false;"' + str + ' >'
                                            + '							<span class="red">'
                                            + '								<i class="icon-trash bigger-120"></i>'
                                            + '							</span>'
                                            + '						</a>'
    ...
    <script type="text/javascript">
        ...
        function LoadDataGPI(id) {
            var param = "{'id':" + JSON.stringify(id) + "}";
            var dataurl = 'WebService/WebService.asmx/LoadSpeedwayGPI';
            $.ajax({
                "type": "POST",
                "dataType": 'json',
                "contentType": "application/json; charset=utf-8",
    ...
    <script type="text/javascript">
        ...
        function LoadDataTagFilter(id) {
            var param = "{'id':" + JSON.stringify(id) + "}";
            var dataurl = 'WebService/WebService.asmx/LoadSpeedwayTagFilter';
            $.ajax({
                "type": "POST",
                "dataType": 'json',
                "contentType": "application/json; charset=utf-8",
