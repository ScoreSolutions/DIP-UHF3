<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmReturnByOfficer.aspx.vb" Inherits="frmReturnByOfficer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">รายงานการคืนแฟ้ม(รายคน)</li>
            </ul>
            <!--.breadcrumb-->
        ...
        <div class="page-content">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="row-fluid">
                        <h3 class="header smaller lighter blue">รายงานการคืนแฟ้ม(รายคน)</h3>
                    ...
                    <div class="row-fluid">
                        <div class="span2">
                            <label class="control-label" for="lblBrrowDate">วันที่คืน</label>
    ...
    <script type="text/javascript">
       ...
       function populateSearch() {
            ...
            var reportname = 'frmReturnByOfficer';
            var officerid = $("#txtUserId").val();
            var fullname = encodeURIComponent($('#' + '<%=Master.FindControl("lblfullname").ClientID%>').text());
            var datefrom = $('#datefrom').val();
            var dateto = $('#dateto').val();
            var para = hostreport + '?reportname=' + reportname + '&officerid=' + officerid + '&datefrom=' + datefrom + '&dateto=' + dateto + '&fullname=' + fullname ;
