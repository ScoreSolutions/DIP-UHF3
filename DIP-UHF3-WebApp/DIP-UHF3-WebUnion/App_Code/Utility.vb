...
#Region "DefaultString Return"
    Public Class DefaultStringStatusReturn
        ...
        Public Shared deletefilefail As String = "DELETEFILEFAIL" 'ลบไม่สำเร็จ
        ...
        Public Shared IncorrectPassword As String = "INCORRECTPASSWORD"
        Public Shared duplicate_layout_name As String = "DUPLICATELAYOUTNAME" 'ข้อมูลซ้ำ
        Public Shared reference As String = "REFERENCE" 'ข้อมูลถูกใช้งาน
        Public Shared duplicate_desk_name As String = "DUPLICATEDESKNAME" 'ข้อมูลซ้ำ
        Public Shared duplicate_patent_type_code As String = "DUPLICATEPATENTTYPECODE" 'ข้อมูลซ้ำ
        Public Shared duplicate_patent_type_name As String = "DUPLICATEPATENTTYPENAME" 'ข้อมูลซ้ำ
        Public Shared duplicate_floor_plan As String = "DUPLICATEFLOORPLAN" 'ข้อมูลซ้ำ
        Public Shared duplicate_floor_plan_name As String = "DUPLICATEFLOORPLANNAME" 'ข้อมูลซ้ำ
        Public Shared duplicate_speedway_serailno As String = "DUPLICATESPEEDWAYSERAILNO" 'ข้อมูลซ้ำ
        Public Shared duplicate_led_tvname As String = "DUPLICATELEDTVNAME" 'ข้อมูลซ้ำ
        Public Shared duplicate_led_ipaddress As String = "DUPLICATELEDIPADDRESS" 'ข้อมูลซ้ำ
        Public Shared duplicate_led_macaddress As String = "DUPLICATELEDMACADDRESS" 'ข้อมูลซ้ำ
        Public Shared duplicate_schedulename As String = "DUPLICATESCHEDULENAME" 'ข้อมูลซ้ำ
        Public Shared duplicate_schedulestartdate As String = "DUPLICATESCHEDULESTARTDATE" 'ข้อมูลซ้ำ
        Public Shared duplicate_scheduletime As String = "DUPLICATESCHEDULETIME" 'ข้อมูลซ้ำ
        Public Shared duplicate_floorname As String = "DUPLICATEFLOORNAME" 'ข้อมูลซ้ำ
        Public Shared duplicate_roomname As String = "DUPLICATEROOMNAME" 'ข้อมูลซ้ำ
        Public Shared duplicate_objectivename As String = "DUPLICATEOBJECTIVENAME" 'ข้อมูลซ้ำ
        Public Shared duplicate_sinagecontenttemplate As String = "DUPLICATESINAGECONTENTTEMPLATE" 'ข้อมูลซ้ำ
        Public Shared duplicate_scrollingtext As String = "DUPLICATESCROLLINGTEXT" 'ข้อมูลซ้ำ
        Public Shared duplicate_requisitionapp_no As String = "DUPLICATEREQUISITIONAPPNO" 'ข้อมูลซ้ำ
        Public Shared notfoundtempfile As String = "NOTFOUNDTEMPFILE"
