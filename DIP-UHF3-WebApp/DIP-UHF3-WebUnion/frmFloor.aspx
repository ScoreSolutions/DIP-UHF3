<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage2.master" AutoEventWireup="false" CodeFile="frmFloor.aspx.vb" Inherits="frmFloor" %>
                    ...
                    <div class="control-group">
                        <div class="bootstrap-colorpicker">
                            <input id="colorpicker1" type="text" class="input-mini" style="width:100px"  />
                             <span class="trigger" style="cursor:pointer;cursor:hand;" >X </span>
                        </div>
                    </div>
