...
Namespace Table
    ...
    Public Class TbGateConsoleLogDAL
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("readerid")) = False Then _READERID = Convert.ToDateTime(Rdr("readerid"))
        ...
        Private Function doMappingData(ByVal ret As TbGateConsoleLogData, ByVal RDr As DataRow) As TbGateConsoleLogData
            ...
            If Convert.IsDBNull(RDr("readerid")) = False Then ret.READERID = RDr("readerid").ToString()
        ...
        Private ReadOnly Property SqlInsert() As String
            Get
                Dim Sql As String = ""
                Sql += "INSERT INTO " & TableName & " (ID, APP_NO, TIMESTAMP, ISALARM, ALARM_DISABLE_TIME, READERID, CREATEBY, CREATEON, UPDATEBY, UPDATEON)"
                Sql += " VALUES("
        ...
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "READERID = " & DB.SetString(_READERID) & ", "
