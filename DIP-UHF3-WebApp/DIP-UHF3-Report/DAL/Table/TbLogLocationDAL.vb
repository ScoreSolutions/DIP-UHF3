...
Namespace Table
    'Represents a transaction for TB_LOG_LOCATION table DAL.
    '[Create by  on September, 16 2014]
    Public Class TbLogLocationDAL
        Public Sub TbLogLocationDAL()
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(ByVal cid As Long, ByVal trans As SQLTransaction) As TbLogLocationDAL
        ...
        '/// Returns an indication whether the record of TB_LOG_LOCATION by specified APP_NO key is retrieved successfully.
        ...
        '/// Returns an indication whether the record of TB_LOG_LOCATION by specified LOG_DATE key is retrieved successfully.
        '/// <param name=cLOG_DATE>The LOG_DATE key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByLOG_DATE(ByVal cLOG_DATE As DateTime, ByVal trans As SQLTransaction) As Boolean
            Return doChkData("LOG_DATE = " & DB.SetDateTime(cLOG_DATE) & " ", trans)
        End Function



        '/// Returns an indication whether the record of TB_LOG_LOCATION by specified READERID key is retrieved successfully.
        '/// <param name=cREADERID>The READERID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByREADERID(ByVal cREADERID As String, ByVal trans As SQLTransaction) As Boolean
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(ByVal whText As String, ByVal trans As SQLTransaction) As TbLogLocationDAL
            ClearData()
            _haveData = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
