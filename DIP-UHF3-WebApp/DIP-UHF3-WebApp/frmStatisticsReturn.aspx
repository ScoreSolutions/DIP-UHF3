<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmStatisticsReturn.aspx.vb" Inherits="frmStatisticsReturn" %>
...
<div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">รายงานสถิติการคืนแฟ้ม</li>
            </ul>
            <!--.breadcrumb-->
        ...
        <div class="page-content">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="row-fluid">
                        <h3 class="header smaller lighter blue">รายงานสถิติการคืนแฟ้ม</h3>
                    ...
                    <div class="row-fluid">
                     ...
                     <div class="row-fluid">
                        <div class="span2">
                            <label class="control-label" for="lblDepartment">ประเภทแฟ้ม</label>
                        </div>
                        <div class="span3">
    ...
    <script type="text/javascript">
        ...
        function populateSearch() {
            ...
            var reportname = 'frmStatisticsReturn';
