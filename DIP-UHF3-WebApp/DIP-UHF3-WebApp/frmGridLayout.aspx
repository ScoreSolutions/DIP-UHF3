<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmGridLayout.aspx.vb" Inherits="frmGridLayout" %>
        ...
        <div class="row-fluid" >
            <div class="span12">
                ...
                <div class="span8">
                    ...
                    <span class="help-inline color red" id="lblvalid_VerticalLineminmax" style="display: none">This field must be between 10 and 100</span>
                </div>
         ...
         <div class="row-fluid" >
            <div class="span12">
                ...
                <div class="span8">
                   ...
                   <span class="help-inline color red" id="lblvalid_HorizontalLineminmax" style="display: none">This field must be between 10 and 100</span>
                </div>
    ...
    <script type="text/javascript">
        ...
        function onValid() {
            ...
            if (vertical_line == '') {
                ...
                if ((vertical_line < 10) || ((vertical_line > 100))) {
            ...
            if (horizontal_line == '') {
                ...
                if ((horizontal_line < 10) || (horizontal_line > 100)) {
