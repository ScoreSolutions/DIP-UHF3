<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmGraphBorrowByPatentType.aspx.vb" Inherits="frmGraphBorrowByPatentType" %>
...
<div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">กราฟแสดงรายการยืม-คืนแฟ้ม(ตามประเภทแฟ้ม)</li>
            </ul>
            <!--.breadcrumb-->
        ...
        <div class="page-content">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="row-fluid">
                        <h3 class="header smaller lighter blue">กราฟแสดงรายการยืม-คืนแฟ้ม(ตามประเภทแฟ้ม)</h3>
    ...
    <script type="text/javascript">
        ...
        function populateSearch() {
            ...
            var reportname = 'frmGraphByPatentType';
