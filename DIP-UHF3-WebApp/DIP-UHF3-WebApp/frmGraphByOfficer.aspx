<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmGraphByOfficer.aspx.vb" Inherits="frmGraphByOfficer" %>
...
<div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">กราฟแสดงการยืม - คืนแฟ้ม(ตามเจ้าหน้าที่ห้องแฟ้ม)</li>
            </ul>
            <!--.breadcrumb-->
        ...
        <div class="page-content">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="row-fluid">
                        <h3 class="header smaller lighter blue">กราฟแสดงการยืม - คืนแฟ้ม(ตามเจ้าหน้าที่ห้องแฟ้ม)</h3>
                    ...
                    <div class="row-fluid">
                        <div class="span2">
                            <label class="control-label" for="lblOfficer">ชื่อเจ้าหน้าที่ห้องแฟ้ม</label>
                        </div>
                        <div class="span3">
    ...
    <script type="text/javascript">
        ...
        function populateSearch() {
            ...
            var reportname = 'frmGraphByOfficer';
