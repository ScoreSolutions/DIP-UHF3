...
Partial Class UserControls_txtTime
    ...
    Public Property TimeText() As String
        ...
        End Set
    End Property
    Public Property VisibleStar() As Boolean
        Get
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            TextBox1.Attributes.Add("OnKeyPress", "txtTime_OnKeyPress(this,event);")
            'txtTime_OnKeyPress(this,event)
            TextBox1.Attributes.Add("onKeyDown", "CheckKeyBackSpace();")
            TextBox1.Attributes.Add("onChange", "ValidateTime(this);")
        End If
    End Sub
End Class
