<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmAddProcess.aspx.vb" Inherits="frmAddProcess" %>
                    ...
                    <table style ="width :100%">
                        <tr>
                            <td style="text-align: right; font-size: 12pt;width :150px;">
                             ...
                             <td>
                                 ...
                                 <asp:TextBox ID="txtWindowProcessName" runat="server"></asp:TextBox>
                        ...
                        <tr>
                            <td colspan ="2">
                                ...
                                <asp:GridView ID="gvprocess" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Name">
                                            <ItemTemplate >
                                                <asp:Label ID="lblWindowProcessName" runat="server" Text='<%#Bind("WindowProcessName")%>'></asp:Label>
                                            </ItemTemplate>
                                       ...
                                       <%-- <asp:ButtonField ButtonType="Image" HeaderText="Delete" ImageUrl="~/Images/icon_Delete.png" Text="Delete"  CommandName="DeleteRow" >
                                        ...
                                        <asp:TemplateField HeaderText="Delete">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="Delete" runat="server" CommandName="DeleteRow" ImageUrl="~/Images/icon_Delete.png" CommandArgument='<%#Bind("id")%>' OnClientClick="ConfirmProcess()" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
