...
Namespace Config
    Public Class HDDConfigENG
        ...
        'Public Function SaveHDDConfigWeb(ByVal ShopName As String, ByVal ServerName As String, ByVal IPAddress As String, ByVal dt As DataTable, ByVal RepeateCheck As Integer, ByVal IntervalMinute As Integer, ByVal Active As String) As XDocument
        '    Dim ret As New XDocument
        '    Dim ConfigNode As New XElement("Config")
        '    Dim ConfigDetailNode As New XElement("HDD")
