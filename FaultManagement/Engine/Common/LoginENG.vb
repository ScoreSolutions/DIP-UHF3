...
Namespace Common
    Public Class LoginENG
        ...
        Private Function CheckLDAP(ByVal UserName As String, ByVal PassWD As String) As LinqDB.ConnectDB.LoginSession
        ...
        Public Function GetLoginUserProfile(ByVal UserName As String) As LinqDB.ConnectDB.LoginSession
        ...
        Public Shared Function GetLogOnUser() As LinqDB.ConnectDB.UserProfilePara
