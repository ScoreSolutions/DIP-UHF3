...
Namespace TABLE
    'Represents a transaction for TB_GROUP table LinqDB.
    '[Create by  on October, 13 2014]
    Public Class TbGroupLinqDB
        Public sub TbGroupLinqDB()

        End Sub 
        ' TB_GROUP
        Const _tableName As String = "TB_GROUP"
        ...
        Public Property GROUP_CODE() As String
            ...
            End Set
        End Property 
        <Column(Storage:="_GROUP_DESC", DbType:="VarChar(255) NOT NULL ",CanBeNull:=false)>  _
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_GROUP table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_GROUP table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_GROUP table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_GROUP by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_GROUP by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbGroupLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of TB_GROUP by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbGroupLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table TB_GROUP
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATEDBY, CREATEDDATE, GROUP_CODE, GROUP_DESC, ACTIVE_STATUS)"
                Sql += " VALUES("
                sql += DB.SetDouble(_ID) & ", "
                sql += DB.SetString(_CREATEDBY) & ", "
                sql += DB.SetDateTime(_CREATEDDATE) & ", "
                sql += DB.SetString(_GROUP_CODE) & ", "
                sql += DB.SetString(_GROUP_DESC) & ", "
        ...
        'Get update statement form table TB_GROUP
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "GROUP_DESC = " & DB.SetString(_GROUP_DESC) & ", "
        ...
        'Get Delete Record in table TB_GROUP
        ...
        'Get Select Statement for table TB_GROUP
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATEDBY, CREATEDDATE, UPDATEDBY, UPDATEDDATE, GROUP_CODE, GROUP_DESC, ACTIVE_STATUS FROM " & tableName
                Return Sql
            End Get
        End Property
       ...
       Dim _TB_REGISTER_group_id As DataTable

       Public Property CHILD_TB_REGISTER_group_id() As DataTable
           Get
               'Child Table Name : TB_REGISTER Column :group_id
               Dim trans As New LinqDB.ConnectDB.TransactionDB
               Dim TbRegisterItem As New TbRegisterLinqDB
               _TB_REGISTER_group_id = TbRegisterItem.GetDataList("group_id = " & _ID, "", trans.Trans)
               trans.CommitTransaction()
               TbRegisterItem = Nothing
               Return _TB_REGISTER_group_id
           End Get
           Set(ByVal value As DataTable)
               _TB_REGISTER_group_id = value
           End Set
       End Property
    End Class
End Namespace
