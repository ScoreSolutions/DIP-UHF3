...
Namespace TABLE
    'Represents a transaction for CF_CONFIG_FILELOST table LinqDB.
    '[Create by  on March, 2 2015]
    Public Class CfConfigFilelostLinqDB
        Public sub CfConfigFilelostLinqDB()

        End Sub 
        ' CF_CONFIG_FILELOST
        Const _tableName As String = "CF_CONFIG_FILELOST"
        ...
        Dim _REPEATECHECKQTY As Long = 0
        ...
        Public Property CHECKINTERVALMINUTE() As Long
            ...
            End Set
        End Property 
        <Column(Storage:="_REPEATECHECKQTY", DbType:="Int NOT NULL ",CanBeNull:=false)>  _
        Public Property REPEATECHECKQTY() As Long
            Get
                Return _REPEATECHECKQTY
            End Get
            Set(ByVal value As Long)
               _REPEATECHECKQTY = value
            End Set
        End Property 
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into CF_CONFIG_FILELOST table successfully.
        ...
        '/// Returns an indication whether the current data is updated to CF_CONFIG_FILELOST table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from CF_CONFIG_FILELOST table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of CF_CONFIG_FILELOST by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of CF_CONFIG_FILELOST by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As CfConfigFilelostLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of CF_CONFIG_FILELOST by specified MACADDRESS key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of CF_CONFIG_FILELOST by specified MACADDRESS key is retrieved successfully.
        '/// <param name=cMACADDRESS>The MACADDRESS key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of CF_CONFIG_FILELOST by specified SERVERIP key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of CF_CONFIG_FILELOST by specified SERVERIP key is retrieved successfully.
        '/// <param name=cSERVERIP>The SERVERIP key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of CF_CONFIG_FILELOST by specified SERVERNAME key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of CF_CONFIG_FILELOST by specified SERVERNAME key is retrieved successfully.
        '/// <param name=cSERVERNAME>The SERVERNAME key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of CF_CONFIG_FILELOST by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("RepeateCheckQty")) = False Then _RepeateCheckQty = Convert.ToInt32(Rdr("RepeateCheckQty"))
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As CfConfigFilelostLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table CF_CONFIG_FILELOST
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATEDDATE, CREATEDBY, SERVERNAME, SERVERIP, CHECKINTERVALMINUTE, REPEATECHECKQTY, ACTIVESTATUS, MACADDRESS, ALARMSUN, ALARMMON, ALARMTUE, ALARMWED, ALARMTHU, ALARMFRI, ALARMSAT, ALARMTIMEFROM, ALARMTIMETO, ALLDAYEVENT, LASTCHECKTIME)"
                Sql += " VALUES("
                ...
                sql += DB.SetDouble(_REPEATECHECKQTY) & ", "
        ...
        'Get update statement form table CF_CONFIG_FILELOST
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "REPEATECHECKQTY = " & DB.SetDouble(_REPEATECHECKQTY) & ", "
        ...
        'Get Delete Record in table CF_CONFIG_FILELOST
        ...
        'Get Select Statement for table CF_CONFIG_FILELOST
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATEDDATE, CREATEDBY, UPDATEDDATE, UPDATEDBY, SERVERNAME, SERVERIP, CHECKINTERVALMINUTE, REPEATECHECKQTY, ACTIVESTATUS, MACADDRESS, ALARMSUN, ALARMMON, ALARMTUE, ALARMWED, ALARMTHU, ALARMFRI, ALARMSAT, ALARMTIMEFROM, ALARMTIMETO, ALLDAYEVENT, LASTCHECKTIME FROM " & tableName
                Return Sql
            End Get
        End Property
       ...
       Dim _CF_CONFIG_FILELOST_DETAIL_cf_config_filelost_id As DataTable

       Public Property CHILD_CF_CONFIG_FILELOST_DETAIL_cf_config_filelost_id() As DataTable
           Get
               'Child Table Name : CF_CONFIG_FILELOST_DETAIL Column :cf_config_filelost_id
               Dim trans As New LinqDB.ConnectDB.TransactionDB
               Dim CfConfigFilelostDetailItem As New CfConfigFilelostDetailLinqDB
               _CF_CONFIG_FILELOST_DETAIL_cf_config_filelost_id = CfConfigFilelostDetailItem.GetDataList("cf_config_filelost_id = " & _ID, "", trans.Trans)
               trans.CommitTransaction()
               CfConfigFilelostDetailItem = Nothing
               Return _CF_CONFIG_FILELOST_DETAIL_cf_config_filelost_id
           End Get
           Set(ByVal value As DataTable)
               _CF_CONFIG_FILELOST_DETAIL_cf_config_filelost_id = value
           End Set
       End Property
    End Class
End Namespace
