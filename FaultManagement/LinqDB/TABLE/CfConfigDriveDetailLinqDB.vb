...
Namespace TABLE
    ...
    Public Class CfConfigDriveDetailLinqDB
        ...
        Dim _CF_CONFIG_DRIVE_ID As Long = 0
        ...
        Public Property UPDATEDBY() As  String 
            ...
            End Set
        End Property 
        <Column(Storage:="_CF_CONFIG_DRIVE_ID", DbType:="BigInt NOT NULL ",CanBeNull:=false)>  _
        Public Property CF_CONFIG_DRIVE_ID() As Long
            Get
            ...
            End Set
        End Property 
        <Column(Storage:="_DRIVELETTER", DbType:="VarChar(255) NOT NULL ",CanBeNull:=false)>  _
       ...
       'Define Public Method 
        ...
        Public Function ChkDataByCF_CONFIG_DRIVE_ID_DRIVELETTER(cCF_CONFIG_DRIVE_ID As Long, cDRIVELETTER As String, trans As SQLTransaction) As Boolean
            Return doChkData("CF_CONFIG_DRIVE_ID = " & DB.SetDouble(cCF_CONFIG_DRIVE_ID) & " AND DRIVELETTER = " & DB.SetString(cDRIVELETTER), trans)
        End Function
        ...
        Public Function ChkDuplicateByCF_CONFIG_DRIVE_ID_DRIVELETTER(cCF_CONFIG_DRIVE_ID As Long, cDRIVELETTER As String, cid As Long, trans As SQLTransaction) As Boolean
            Return doChkData("CF_CONFIG_DRIVE_ID = " & DB.SetDouble(cCF_CONFIG_DRIVE_ID) & " AND DRIVELETTER = " & DB.SetString(cDRIVELETTER) & " And id <> " & DB.SetDouble(cid) & " ", trans)
        End Function
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As CfConfigDriveDetailLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        Private ReadOnly Property SqlInsert() As String 
            Get
                ...
                sql += DB.SetDouble(_CF_CONFIG_DRIVE_ID) & ", "
        ...
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "CF_CONFIG_DRIVE_ID = " & DB.SetDouble(_CF_CONFIG_DRIVE_ID) & ", "
