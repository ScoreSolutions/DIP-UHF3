...
Namespace TABLE
    'Represents a transaction for MS_SYSCONFIG table LinqDB.
    '[Create by  on October, 13 2014]
    Public Class MsSysconfigLinqDB
        Public sub MsSysconfigLinqDB()

        End Sub 
        ' MS_SYSCONFIG
        Const _tableName As String = "MS_SYSCONFIG"
        ...
        Public Property CONFIG_NAME() As  String 
            ...
            End Set
        End Property 
        <Column(Storage:="_CONFIG_VALUE", DbType:="VarChar(255)")>  _
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into MS_SYSCONFIG table successfully.
        ...
        '/// Returns an indication whether the current data is updated to MS_SYSCONFIG table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from MS_SYSCONFIG table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of MS_SYSCONFIG by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of MS_SYSCONFIG by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As MsSysconfigLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of MS_SYSCONFIG by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As MsSysconfigLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table MS_SYSCONFIG
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATEDDATE, CREATEDBY, CONFIG_NAME, CONFIG_VALUE, CONFIG_DESC, MACADDRESS)"
                Sql += " VALUES("
        ...
        'Get update statement form table MS_SYSCONFIG
        ...
        'Get Delete Record in table MS_SYSCONFIG
        ...
        'Get Select Statement for table MS_SYSCONFIG
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATEDDATE, CREATEDBY, UPDATEDDATE, UPDATEDBY, CONFIG_NAME, CONFIG_VALUE, CONFIG_DESC, MACADDRESS FROM " & tableName
                Return Sql
            End Get
        End Property
