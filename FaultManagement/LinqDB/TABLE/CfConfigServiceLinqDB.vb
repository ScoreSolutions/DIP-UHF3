...
Namespace TABLE
    'Represents a transaction for CF_CONFIG_SERVICE table LinqDB.
    '[Create by  on March, 8 2015]
    Public Class CfConfigServiceLinqDB
        Public sub CfConfigServiceLinqDB()

        End Sub 
        ' CF_CONFIG_SERVICE
        Const _tableName As String = "CF_CONFIG_SERVICE"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into CF_CONFIG_SERVICE table successfully.
        ...
        '/// Returns an indication whether the current data is updated to CF_CONFIG_SERVICE table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from CF_CONFIG_SERVICE table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of CF_CONFIG_SERVICE by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of CF_CONFIG_SERVICE by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As CfConfigServiceLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of CF_CONFIG_SERVICE by specified SERVERIP key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of CF_CONFIG_SERVICE by specified SERVERIP key is retrieved successfully.
        '/// <param name=cSERVERIP>The SERVERIP key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of CF_CONFIG_SERVICE by specified SERVERNAME key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of CF_CONFIG_SERVICE by specified SERVERNAME key is retrieved successfully.
        '/// <param name=cSERVERNAME>The SERVERNAME key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of CF_CONFIG_SERVICE by specified MACADDRESS key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of CF_CONFIG_SERVICE by specified MACADDRESS key is retrieved successfully.
        '/// <param name=cMACADDRESS>The MACADDRESS key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of CF_CONFIG_SERVICE by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As CfConfigServiceLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table CF_CONFIG_SERVICE
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATEDDATE, CREATEDBY, SERVERIP, SERVERNAME, MACADDRESS, CHECKINTERVALMINUTE, ACTIVESTATUS, ALARMSUN, ALARMMON, ALARMTUE, ALARMWED, ALARMTHU, ALARMFRI, ALARMSAT, ALARMTIMEFROM, ALARMTIMETO, ALLDAYEVENT, LASTCHECKTIME)"
                Sql += " VALUES("
        ...
        'Get update statement form table CF_CONFIG_SERVICE
        ...
        'Get Delete Record in table CF_CONFIG_SERVICE
        ...
        'Get Select Statement for table CF_CONFIG_SERVICE
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATEDDATE, CREATEDBY, UPDATEDDATE, UPDATEDBY, SERVERIP, SERVERNAME, MACADDRESS, CHECKINTERVALMINUTE, ACTIVESTATUS, ALARMSUN, ALARMMON, ALARMTUE, ALARMWED, ALARMTHU, ALARMFRI, ALARMSAT, ALARMTIMEFROM, ALARMTIMETO, ALLDAYEVENT, LASTCHECKTIME FROM " & tableName
                Return Sql
            End Get
        End Property
       ...
       Dim _CF_CONFIG_SERVICE_DETAIL_cf_config_service_id As DataTable

       Public Property CHILD_CF_CONFIG_SERVICE_DETAIL_cf_config_service_id() As DataTable
           Get
               'Child Table Name : CF_CONFIG_SERVICE_DETAIL Column :cf_config_service_id
               Dim trans As New LinqDB.ConnectDB.TransactionDB
               Dim CfConfigServiceDetailItem As New CfConfigServiceDetailLinqDB
               _CF_CONFIG_SERVICE_DETAIL_cf_config_service_id = CfConfigServiceDetailItem.GetDataList("cf_config_service_id = " & _ID, "", trans.Trans)
               trans.CommitTransaction()
               CfConfigServiceDetailItem = Nothing
               Return _CF_CONFIG_SERVICE_DETAIL_cf_config_service_id
           End Get
           Set(ByVal value As DataTable)
               _CF_CONFIG_SERVICE_DETAIL_cf_config_service_id = value
           End Set
       End Property
    End Class
End Namespace
