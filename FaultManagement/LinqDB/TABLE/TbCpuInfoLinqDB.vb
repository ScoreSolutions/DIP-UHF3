...
Namespace TABLE
    'Represents a transaction for TB_CPU_INFO table LinqDB.
    '[Create by  on Febuary, 25 2015]
    Public Class TbCpuInfoLinqDB
        Public sub TbCpuInfoLinqDB()

        End Sub 
        ' TB_CPU_INFO
        Const _tableName As String = "TB_CPU_INFO"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_CPU_INFO table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_CPU_INFO table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_CPU_INFO table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_CPU_INFO by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_CPU_INFO by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbCpuInfoLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of TB_CPU_INFO by specified SERVERIP key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of TB_CPU_INFO by specified SERVERIP key is retrieved successfully.
        '/// <param name=cSERVERIP>The SERVERIP key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of TB_CPU_INFO by specified SERVERNAME key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of TB_CPU_INFO by specified SERVERNAME key is retrieved successfully.
        '/// <param name=cSERVERNAME>The SERVERNAME key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of TB_CPU_INFO by specified MACADDRESS key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of TB_CPU_INFO by specified MACADDRESS key is retrieved successfully.
        '/// <param name=cMACADDRESS>The MACADDRESS key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of TB_CPU_INFO by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbCpuInfoLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table TB_CPU_INFO
        ...
        'Get update statement form table TB_CPU_INFO
        ...
        'Get Delete Record in table TB_CPU_INFO
        ...
        'Get Select Statement for table TB_CPU_INFO
