...
Namespace TABLE
    'Represents a transaction for CF_CONFIG_PROCESS table LinqDB.
    '[Create by  on March, 8 2015]
    Public Class CfConfigProcessLinqDB
        Public sub CfConfigProcessLinqDB()

        End Sub 
        ' CF_CONFIG_PROCESS
        Const _tableName As String = "CF_CONFIG_PROCESS"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into CF_CONFIG_PROCESS table successfully.
        ...
        '/// Returns an indication whether the current data is updated to CF_CONFIG_PROCESS table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from CF_CONFIG_PROCESS table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of CF_CONFIG_PROCESS by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of CF_CONFIG_PROCESS by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As CfConfigProcessLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of CF_CONFIG_PROCESS by specified SERVERIP key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of CF_CONFIG_PROCESS by specified SERVERIP key is retrieved successfully.
        '/// <param name=cSERVERIP>The SERVERIP key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of CF_CONFIG_PROCESS by specified SERVERNAME key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of CF_CONFIG_PROCESS by specified SERVERNAME key is retrieved successfully.
        '/// <param name=cSERVERNAME>The SERVERNAME key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of CF_CONFIG_PROCESS by specified MACADDRESS key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of CF_CONFIG_PROCESS by specified MACADDRESS key is retrieved successfully.
        '/// <param name=cMACADDRESS>The MACADDRESS key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of CF_CONFIG_PROCESS by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As CfConfigProcessLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table CF_CONFIG_PROCESS
        ...
        'Get update statement form table CF_CONFIG_PROCESS
        ...
        'Get Delete Record in table CF_CONFIG_PROCESS
        ...
        'Get Select Statement for table CF_CONFIG_PROCESS
       ...
       Dim _CF_CONFIG_PROCESS_DETAIL_cf_config_process_id As DataTable

       Public Property CHILD_CF_CONFIG_PROCESS_DETAIL_cf_config_process_id() As DataTable
           Get
               'Child Table Name : CF_CONFIG_PROCESS_DETAIL Column :cf_config_process_id
               Dim trans As New LinqDB.ConnectDB.TransactionDB
               Dim CfConfigProcessDetailItem As New CfConfigProcessDetailLinqDB
               _CF_CONFIG_PROCESS_DETAIL_cf_config_process_id = CfConfigProcessDetailItem.GetDataList("cf_config_process_id = " & _ID, "", trans.Trans)
               trans.CommitTransaction()
               CfConfigProcessDetailItem = Nothing
               Return _CF_CONFIG_PROCESS_DETAIL_cf_config_process_id
           End Get
           Set(ByVal value As DataTable)
               _CF_CONFIG_PROCESS_DETAIL_cf_config_process_id = value
           End Set
       End Property
    End Class
End Namespace
