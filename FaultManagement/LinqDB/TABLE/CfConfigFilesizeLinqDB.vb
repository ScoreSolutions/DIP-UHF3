...
Namespace TABLE
    'Represents a transaction for CF_CONFIG_FILESIZE table LinqDB.
    '[Create by  on March, 2 2015]
    Public Class CfConfigFilesizeLinqDB
        Public sub CfConfigFilesizeLinqDB()

        End Sub 
        ' CF_CONFIG_FILESIZE
        Const _tableName As String = "CF_CONFIG_FILESIZE"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into CF_CONFIG_FILESIZE table successfully.
        ...
        '/// Returns an indication whether the current data is updated to CF_CONFIG_FILESIZE table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from CF_CONFIG_FILESIZE table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of CF_CONFIG_FILESIZE by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of CF_CONFIG_FILESIZE by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As CfConfigFilesizeLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of CF_CONFIG_FILESIZE by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As CfConfigFilesizeLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table CF_CONFIG_FILESIZE
        ...
        'Get update statement form table CF_CONFIG_FILESIZE
        ...
        'Get Delete Record in table CF_CONFIG_FILESIZE
        ...
        'Get Select Statement for table CF_CONFIG_FILESIZE
       ...
       Dim _CF_CONFIG_FILESIZE_DETAIL_cf_config_filesize_id As DataTable

       Public Property CHILD_CF_CONFIG_FILESIZE_DETAIL_cf_config_filesize_id() As DataTable
           Get
               'Child Table Name : CF_CONFIG_FILESIZE_DETAIL Column :cf_config_filesize_id
               Dim trans As New LinqDB.ConnectDB.TransactionDB
               Dim CfConfigFilesizeDetailItem As New CfConfigFilesizeDetailLinqDB
               _CF_CONFIG_FILESIZE_DETAIL_cf_config_filesize_id = CfConfigFilesizeDetailItem.GetDataList("cf_config_filesize_id = " & _ID, "", trans.Trans)
               trans.CommitTransaction()
               CfConfigFilesizeDetailItem = Nothing
               Return _CF_CONFIG_FILESIZE_DETAIL_cf_config_filesize_id
           End Get
           Set(ByVal value As DataTable)
               _CF_CONFIG_FILESIZE_DETAIL_cf_config_filesize_id = value
           End Set
       End Property
    End Class
End Namespace
