...
Namespace TABLE
    'Represents a transaction for CF_CONFIG_PORT table LinqDB.
    '[Create by  on March, 7 2015]
    Public Class CfConfigPortLinqDB
        Public sub CfConfigPortLinqDB()

        End Sub 
        ' CF_CONFIG_PORT
        Const _tableName As String = "CF_CONFIG_PORT"
        ...
        Public Property HOSTIP() As  String 
            ...
            End Set
        End Property 
        <Column(Storage:="_HOSTNAME", DbType:="VarChar(255)")>  _
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into CF_CONFIG_PORT table successfully.
        ...
        '/// Returns an indication whether the current data is updated to CF_CONFIG_PORT table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from CF_CONFIG_PORT table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of CF_CONFIG_PORT by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of CF_CONFIG_PORT by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As CfConfigPortLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of CF_CONFIG_PORT by specified HOSTIP key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of CF_CONFIG_PORT by specified HOSTIP key is retrieved successfully.
        '/// <param name=cHOSTIP>The HOSTIP key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of CF_CONFIG_PORT by specified HOSTNAME key is retrieved successfully.
        '/// <param name=cHOSTNAME>The HOSTNAME key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByHOSTNAME(cHOSTNAME As String, trans As SQLTransaction) As Boolean
            Return doChkData("HOSTNAME = " & DB.SetString(cHOSTNAME) & " ", trans)
        End Function

        '/// Returns an duplicate data record of CF_CONFIG_PORT by specified HOSTNAME key is retrieved successfully.
        '/// <param name=cHOSTNAME>The HOSTNAME key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByHOSTNAME(cHOSTNAME As String, cid As Long, trans As SQLTransaction) As Boolean
            Return doChkData("HOSTNAME = " & DB.SetString(cHOSTNAME) & " " & " And id <> " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of CF_CONFIG_PORT by specified MACADDRESS key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of CF_CONFIG_PORT by specified MACADDRESS key is retrieved successfully.
        '/// <param name=cMACADDRESS>The MACADDRESS key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of CF_CONFIG_PORT by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("HostName")) = False Then _HostName = Rdr("HostName").ToString()
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As CfConfigPortLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table CF_CONFIG_PORT
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (CREATEDDATE, CREATEDBY, HOSTIP, HOSTNAME, MACADDRESS, ALARMSUN, ALARMMON, ALARMTUE, ALARMWED, ALARMTHU, ALARMFRI, ALARMSAT, ALARMTIMEFROM, ALARMTIMETO, ALLDAYEVENT, LASTCHECKTIME, ACTIVESTATUS)"
                Sql += " VALUES("
                sql += DB.SetDateTime(_CREATEDDATE) & ", "
                sql += DB.SetString(_CREATEDBY) & ", "
                sql += DB.SetString(_HOSTIP) & ", "
                sql += DB.SetString(_HOSTNAME) & ", "
        ...
        'Get update statement form table CF_CONFIG_PORT
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "HOSTNAME = " & DB.SetString(_HOSTNAME) & ", "
        ...
        'Get Delete Record in table CF_CONFIG_PORT
        ...
        'Get Select Statement for table CF_CONFIG_PORT
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATEDDATE, CREATEDBY, UPDATEDDATE, UPDATEDBY, HOSTIP, HOSTNAME, MACADDRESS, ALARMSUN, ALARMMON, ALARMTUE, ALARMWED, ALARMTHU, ALARMFRI, ALARMSAT, ALARMTIMEFROM, ALARMTIMETO, ALLDAYEVENT, LASTCHECKTIME, ACTIVESTATUS FROM " & tableName
                Return Sql
            End Get
        End Property
       ...
       Dim _CF_CONFIG_PORT_DETAIL_cf_config_port_id As DataTable

       Public Property CHILD_CF_CONFIG_PORT_DETAIL_cf_config_port_id() As DataTable
           Get
               'Child Table Name : CF_CONFIG_PORT_DETAIL Column :cf_config_port_id
               Dim trans As New LinqDB.ConnectDB.TransactionDB
               Dim CfConfigPortDetailItem As New CfConfigPortDetailLinqDB
               _CF_CONFIG_PORT_DETAIL_cf_config_port_id = CfConfigPortDetailItem.GetDataList("cf_config_port_id = " & _ID, "", trans.Trans)
               trans.CommitTransaction()
               CfConfigPortDetailItem = Nothing
               Return _CF_CONFIG_PORT_DETAIL_cf_config_port_id
           End Get
           Set(ByVal value As DataTable)
               _CF_CONFIG_PORT_DETAIL_cf_config_port_id = value
           End Set
       End Property
    End Class
End Namespace
