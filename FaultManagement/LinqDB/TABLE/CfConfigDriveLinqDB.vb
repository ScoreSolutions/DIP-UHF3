...
Namespace TABLE
    'Represents a transaction for CF_CONFIG_DRIVE table LinqDB.
    '[Create by  on March, 2 2015]
    Public Class CfConfigDriveLinqDB
        Public sub CfConfigDriveLinqDB()

        End Sub 
        ' CF_CONFIG_DRIVE
        Const _tableName As String = "CF_CONFIG_DRIVE"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into CF_CONFIG_DRIVE table successfully.
        ...
        '/// Returns an indication whether the current data is updated to CF_CONFIG_DRIVE table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from CF_CONFIG_DRIVE table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of CF_CONFIG_DRIVE by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of CF_CONFIG_DRIVE by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As CfConfigDriveLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of CF_CONFIG_DRIVE by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As CfConfigDriveLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table CF_CONFIG_DRIVE
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATEDDATE, CREATEDBY, SERVERNAME, SERVERIP, CHECKINTERVALMINUTE, REPEATCHECKQTY, ACTIVESTATUS, MACADDRESS, ALARMSUN, ALARMMON, ALARMTUE, ALARMWED, ALARMTHU, ALARMFRI, ALARMSAT, ALARMTIMEFROM, ALARMTIMETO, ALLDAYEVENT, LASTCHECKTIME)"
                Sql += " VALUES("
        ...
        'Get update statement form table CF_CONFIG_DRIVE
        ...
        'Get Delete Record in table CF_CONFIG_DRIVE
        ...
        'Get Select Statement for table CF_CONFIG_DRIVE
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATEDDATE, CREATEDBY, UPDATEDDATE, UPDATEDBY, SERVERNAME, SERVERIP, CHECKINTERVALMINUTE, REPEATCHECKQTY, ACTIVESTATUS, MACADDRESS, ALARMSUN, ALARMMON, ALARMTUE, ALARMWED, ALARMTHU, ALARMFRI, ALARMSAT, ALARMTIMEFROM, ALARMTIMETO, ALLDAYEVENT, LASTCHECKTIME FROM " & tableName
                Return Sql
            End Get
        End Property
       ...
       Dim _CF_CONFIG_DRIVE_DETAIL_cf_config_drive_id As DataTable

       Public Property CHILD_CF_CONFIG_DRIVE_DETAIL_cf_config_drive_id() As DataTable
           Get
               'Child Table Name : CF_CONFIG_DRIVE_DETAIL Column :cf_config_drive_id
               Dim trans As New LinqDB.ConnectDB.TransactionDB
               Dim CfConfigDriveDetailItem As New CfConfigDriveDetailLinqDB
               _CF_CONFIG_DRIVE_DETAIL_cf_config_drive_id = CfConfigDriveDetailItem.GetDataList("cf_config_drive_id = " & _ID, "", trans.Trans)
               trans.CommitTransaction()
               CfConfigDriveDetailItem = Nothing
               Return _CF_CONFIG_DRIVE_DETAIL_cf_config_drive_id
           End Get
           Set(ByVal value As DataTable)
               _CF_CONFIG_DRIVE_DETAIL_cf_config_drive_id = value
           End Set
       End Property
    End Class
End Namespace
