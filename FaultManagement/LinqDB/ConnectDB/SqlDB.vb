    ...
    Public Class SqlDB
        ...
        Private Shared ReadOnly Property INIFileName() As IniReader
            Get
                ...
                Dim INIFlie As String = "C:\Windows\FaultMngDB.ini"
                Dim ini As New IniReader(INIFlie)
                ini.Section = "FaultMngDB"
                Return ini
            End Get
        End Property
        ...
        Public Shared ReadOnly Property DBServerName() As String
            Get
                ...
                Return ini.ReadString("FaultServerName")
            End Get
        End Property
        Public Shared ReadOnly Property DBDatabaseName() As String
            Get
                Dim ini As IniReader = INIFileName
                Return ini.ReadString("FaultDbName")
            End Get
        End Property
        ...
        Public Shared ReadOnly Property DBDbUserID() As String
            Get
                Dim ini As IniReader = INIFileName
                Return ini.ReadString("FaultDbUserID")
            End Get
        End Property
        ...
        Public Shared ReadOnly Property DBDbPwd() As String
            Get
                Dim ini As IniReader = INIFileName
                Return DeCripPwd(ini.ReadString("FaultDbPwd"))
            End Get
        End Property
